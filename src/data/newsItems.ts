...
자세한 매물은 SORI 부동산 카테고리에서 확인하세요.`,
  ...
  },
  {
    ...
    category: "경제",
    catStyle: "bg-[#EBF0FB] text-[#2050A0]",
    title: "💱 원·싱달러 환율 ₩1,048선 — 송금 타이밍과 6월 환율 전망",
    summary: "SGD/KRW 약 1,048원 부근 등락. 미 금리·원화 약세 영향. 한국 송금은 분할 송금 전략 권장. Wise·Instarem 등 핀테크 수수료 비교 정리.",
    fullContent: `싱가포르 달러 대비 원화 환율이 1싱달러당 1,048원 부근에서 등락하고 있습니다. 한국으로 송금하거나 받는 한인들에게 환율은 중요한 관심사입니다.

**최근 환율 동향**
- SGD 1 = 약 ₩1,048 (5월 말 기준)
- 변동 요인: 미국 금리 정책, 원화 상대적 약세
- 6월 전망: 전문가들은 1,040~1,060원 박스권 예상
