...
const RAW_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    title: "🪪 S Pass 최저급여 7/1부터 S$3,600 발효 — 갱신·신규 신청 즉시 적용",
    summary: "7월 1일부터 S Pass 최저 월급여가 일반 업종 S$3,300→S$3,600, 금융업 S$3,800→S$4,000으로 인상됐다. 로컬자격급여(LQS)도 S$1,600→S$1,800로 올라 고용주의 쿼터 산정에 영향을 준다. 기존 S Pass 보유자도 갱신 시 새 기준을 충족해야 하며, 7월 이후 신규·갱신 신청은 모두 S$3,600 이상이어야 한다.",
    fullContent: `**S Pass 최저급여 인상 발효 (2026년 7월 1일)**
인력부(MOM)가 사전 예고한 S Pass 최저 급여 인상이 7월 1일부터 시행됐습니다.

**변경 내용**
- 일반 업종: **S$3,300 → S$3,600/월**
- 금융 서비스업: **S$3,800 → S$4,000/월**
- 연령이 높아질수록 요구 급여가 더 높아지는 연령 기반 기준도 함께 상향

**로컬자격급여(LQS) 인상 — 고용주 쿼터 영향**
- 풀타임 로컬 직원 LQS: **S$1,600 → S$1,800/월** (7/1 발효)
- LQS 미만으로 고용된 로컬 직원은 S Pass 쿼터 산정에서 제외 → 쿼터 감소 가능
- 한인 자영업·요식업 등 외국인 고용 사업주는 로컬 직원 급여 현황 확인 필요

**S Pass 보유자·예정자 체크포인트**
- 현재 급여가 S$3,599 이하면 갱신 시 거부될 수 있음 — 고용주에게 급여 인상 협의 필요
- 7월 이후 신규 신청도 새 기준 충족 필수
- 2027년 1월부터 EP 최저 급여도 추가 인상 예정 (일반 S$5,600→S$6,000)

정확한 기준과 자격 요건은 MOM 공식 안내(아래 출처)에서 반드시 확인하세요.`,
    source: "MOM · Synchro · Singapore Employment Agency",
    sources: [
      { name: "MOM — S Pass 변경 안내 (공식)", url: "https://www.mom.gov.sg/passes-and-permits/s-pass/upcoming-changes-to-s-pass-eligibility" },
      { name: "Synchro — S Pass 7월 급여 변경 고용주 가이드", url: "https://synchro.com.sg/s-pass-salary-changes-july-2026-what-singapore-smes-must-do-before-the-deadline/" },
      { name: "Singapore Employment Agency — S Pass 급여 인상 7월 2026", url: "https://singaporeemploymentagency.com/s-pass-salary-increase-july-2026/" },
    ],
    time: "2026년 7월 1일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "🦟 뎅기열 DENV-3 서로타입 우세 전환 — 2분기 87.8% 급증·면역 없는 혈청형 확산 경고",
    summary: "NEA 7월 21일 분기 보고에 따르면 DENV-3 혈청형 비중이 1월 19.1%에서 6월 59.9%로 급증했다. 2분기(4~6월) 확진은 770건으로 1분기(410건) 대비 87.8% 증가. DENV-3는 수년간 비주류였기 때문에 많은 사람이 면역이 없어 확산 위험이 높다고 전문가들은 경고한다. 2026년 상반기 누적은 1,180건으로 지난해 동기(2,583건) 대비 줄었으나, 피크 시즌(5~10월)에 증가세가 뚜렷하다.",
    fullContent: `**뎅기열 DENV-3 서로타입 전환 경고 (NEA 분기 보고, 2026년 7월 21일)**
NEA 2분기 뎅기 감시 데이터와 전문가 분석입니다.

**혈청형 전환 — 핵심 위험 신호**
- DENV-3 비중: 1월 **19.1%** → 6월 **59.9%**로 급증
- 7월 초(역학주 27, 7/5~11) 기준 DENV-2 48.1% / DENV-3 51.9%
- DENV-3는 최근 수년간 비주류 → **대다수에게 교차 면역이 없어** 대규모 확산 위험↑

**확진 추이**
- 2026년 1분기(1~3월): **410건**
- 2026년 2분기(4~6월): **770건** → 1분기 대비 **+87.8%**
- 2026년 상반기 누적: 약 **1,180건** (2025년 동기 2,583건 대비 54% 낮으나 최근 가속)
- 역학주 27 주간 확진: **118건**

**피크 시즌 중 주의 사항 (5~10월)**
- NEA myENV 앱에서 자택·직장 주변 레드얼럿 클러스터 실시간 확인
- 실내외 고인 물 즉시 제거 (화분 받침·에어컨 배수반·양동이)
- 갑작스러운 고열(38.5°C↑)·두통·관절통·눈 뒤 통증은 GP 방문 후 NS1 검사 요청

정확한 최신 현황과 클러스터 정보는 아래 출처(NEA)를 확인하세요.`,
    source: "Asia News Network · Dengue Visual Atlas · NEA",
    sources: [
      { name: "Asia News Network — Dengue cases low but increasing, DENV-3 strain change", url: "https://asianews.network/dengue-cases-in-singapore-low-but-increasing-numbers-may-rise-further-with-dengue-strain-change/" },
      { name: "Dengue Visual Atlas — Singapore mixed DENV-2 DENV-3 predominance", url: "https://denguevisualatlas.com/en/dengue-in-singapore-mixed-predominance-of-den2-and-den3/" },
      { name: "NEA — 뎅기 클러스터 실시간", url: "https://www.nea.gov.sg/dengue-zika" },
    ],
    time: "2026년 7월 21일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "🌙 싱가포르 나이트 페스티벌 2026 — 8/21~9/5 브라스바사, '신화·전설' 테마 무료 야경",
    summary: "국립문화유산청(NHB)이 8월 21일부터 9월 5일까지 브라스바사·부기스 일대에서 제17회 싱가포르 나이트 페스티벌을 개최한다. 테마는 '신화와 전설(Myths and Legends)'. 국립박물관 외벽 프로젝션 맵핑(Tales of Earth & Sea), 빛 조형물, 야외 전시 등이 무료 공개되며, 금·토 오후 7:30~자정, 일~목 오후 7:30~11시 운영된다. 일부 프로그램은 유료 예약이 필요하다.",
    fullContent: `**싱가포르 나이트 페스티벌 2026 (8월 21일~9월 5일)**
국립문화유산청(NHB)이 주최하는 제17회 나이트 페스티벌입니다.

**일정·위치·운영 시간**
- 기간: **8월 21일(목) ~ 9월 5일(토)**
- 장소: **브라스바사·부기스(Bras Basah.Bugis)** 일대 — 국립박물관·어린이박물관·주변 문화유산 공간
- 금·토: 오후 **7:30~자정(00:00)**
- 일~목: 오후 **7:30~오후 11:00**
- 입장: **무료** (일부 프로그램·체험은 유료 예약 필요)

**테마: 신화와 전설(Myths and Legends)**
싱가포르·동남아의 신화·민담·역사를 몰입형 체험으로 풀어냄

**주요 볼거리**
- **프로젝션 맵핑 — Tales of Earth & Sea**: 국립박물관 외벽 대형 빛 공연 (로컬 신화·전설 주제, 오리지널 사운드트랙)
- **MALAM 프로젝션 맵핑 공모전**: 동남아 신진 아티스트 작품 경합 (50개 이상 출품)
- **공포 영화 시리즈**: Asian Film Archive 큐레이션, 패널 토크 포함
- 빛 조형물 산책 루트, 야외 설치 전시

**한인 가정 팁**
- 무료 입장이라 가족 나들이로 적합 — 브라스바사 MRT역(CC·DT 라인) 이용 추천
- 기간 중 주변 식당이 붐비니 저녁 예약 또는 일찍 식사 후 방문 권장

정확한 행사·티켓 정보는 아래 공식 출처를 확인하세요.`,
    source: "NHB · Sassy Mama · The Smart Local",
    sources: [
      { name: "NHB — Singapore Night Festival 2026 (공식)", url: "https://www.heritage.sg/sgnightfest/" },
      { name: "Sassy Mama — Night Festival 2026 가이드", url: "https://www.sassymamasg.com/event/singapore-night-festival-bras-basah-bugis/" },
      { name: "The Smart Local — Night Festival 2026", url: "https://thesmartlocal.com/read/singapore-night-festival-2026/" },
    ],
    time: "2026년 8월",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "문화",
    catStyle: "bg-[#F5F0FF] text-[#7040C0]",
    title: "🎑 음력 7월 귀신월(孤魂月) 8/13~9/10 — 거리 제물·게타이 공연 안내 (피크 8/27)",
    summary: "올해 음력 7월(鬼月, 귀신월)은 8월 13일(수)에 시작해 9월 10일(수)에 끝난다. 피크일인 보름날(7월 15일)은 8월 27일이다. 이 기간 거리에 제물·음식이 놓이고 밤사이 게타이(歌台) 공연 소음이 들릴 수 있어, 처음 맞는 한인 가정이 당황하지 않도록 기본 예절과 실생활 팁을 안내한다.",
    fullContent: `**2026년 귀신월(孤魂月) 안내 — 음력 7월**
중화 문화권에서 전해지는 음력 7월은 '귀신월'입니다. 싱가포르 생활에서 한인이 알아두면 좋은 정보입니다.

**주요 날짜**
- 시작(문 열림): **8월 13일(수)**
- 피크일(음력 7월 15일 보름날): **8월 27일(목)**
- 종료(문 닫힘): **9월 10일(수)**

**일상에서 볼 수 있는 것들**
- 거리·주차장·HDB 빈 공터에 **제물(음식·과일·향·종이돈 등)**이 차려짐
- 임시 **게타이(歌台)** 무대 설치 — 중국어 공연·음악 소음이 밤사이 들릴 수 있음
- 사원·주거단지 앞에서 **지전(종이돈)을 태우는** 연기·냄새
- 자선 경매(토탄 경매), 중국 오페라(와양) 공연

**한인 예절 팁**
- 거리의 제물·향·음식을 밟거나 치우지 말 것 (중화권 주민에게 결례)
- 타오르는 종이돈 화로 옆을 지날 때 함부로 건드리지 말 것
- 아이들에게 "이웃 문화의 추모 행사"라고 미리 설명하면 좋음
- 게타이 공연으로 밤 소음이 증가할 수 있으니, 예민하다면 창문 닫고 생활

**참고**
- 종이돈·제물은 NEA 지정 구역에서만 태우도록 규정, 무단 연소 시 벌금
- 귀신월이 끝나는 9월 10일 이후 거리·소음은 원상 복귀됨

정확한 날짜·관련 규정은 아래 출처를 확인하세요.`,
    source: "Everyday People SG · Sassy Mama · Awareness Days",
    sources: [
      { name: "Everyday People SG — Hungry Ghost Festival 2026 가이드", url: "https://everydaypeople.sg/hungry-ghost-festival/" },
      { name: "Sassy Mama — Hungry Ghost Festival 2026", url: "https://www.sassymamasg.com/kid-friendly-guide-hungry-ghost-festival/" },
      { name: "Awareness Days — Hungry Ghost Festival 2026 날짜", url: "https://www.awarenessdays.com/awareness-days-calendar/hungry-ghost-festival/" },
    ],
    time: "2026년 8월",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "🏘️ HDB 렌트 6월 +0.6% 반등 — 이그제큐티브 +1.2%·거래량 +4.8%",
    summary: "99-SRX 렌트 리포트에 따르면 6월 HDB 임대료는 전월比 +0.6%(성숙단지 +0.7%, 비성숙 +0.4%)로 5월 하락(-0.3%)에서 반등했다. 유형별로 이그제큐티브 플랫이 +1.2%로 가장 강했고, 4룸은 -0.1%로 소폭 하락. 거래량은 +4.8% 증가해 2,725건(추정). 연간 기준으로는 +1.4%, 성숙단지 +1.8%·비성숙 +0.9%다.",
    fullContent: `**2026년 6월 HDB 임대 시장 (99-SRX 리포트)**
HDB 임대 시장 6월 데이터입니다. 렌트 갱신·이사를 앞둔 한인 가정에 참고가 됩니다.

**월간 변동 (MoM)**
- HDB 전체: **+0.6%** (5월 -0.3%에서 반등)
- 성숙단지(Mature): **+0.7%**
- 비성숙단지(Non-Mature): **+0.4%**
...
**참고**
- 5월 하락(-0.3%)에서 6월에 다시 오른 것으로, 완만한 상승 기조가 이어지는 흐름
- 단지·평형별 편차가 크기 때문에 실제 매물 가격은 직접 확인하세요
