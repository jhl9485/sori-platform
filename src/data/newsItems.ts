...
const RAW_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    title: "📷 NDP 2026 반입 기준 완화 — 프로 카메라·라이브스트리밍 허용, 삼각대·셀카봉·짐벌은 여전히 금지",
    summary: "8월 9일 NDP 주최 측이 반입 기준을 완화해 전문가용 카메라와 라이브스트리밍 기기를 허용하기로 했다. 초기 발표에서 카메라 반입을 금지했다가 대중의 강한 반발을 받고 번복한 것이다. 단, 삼각대·셀카봉·짐벌·모노포드는 여전히 반입이 금지된다. 본행사는 8월 9일(일) 내셔널 스타디움.",
    fullContent: `**NDP 2026 반입 기준 최종 완화 내용**

처음 발표된 NDP 2026 반입 규정이 대중의 거센 반발 후 완화됐습니다.

**허용 (완화된 항목)**
- 전문가용(DSLR·미러리스 등) 카메라
- 라이브스트리밍 기기
...
**행사 일정**
- 본행사: **8월 9일(일)** 내셔널 스타디움(캘랑)
- 프리뷰: 7월 25일·8월 1일 (이미 종료)

정확한 최신 반입 규정은 NDP 공식 채널을 확인하세요.`,
    source: "NDP.gov.sg · The Independent SG",
    sources: [
      { name: "NDP.gov.sg — 공식 반입 규정 공지", url: "https://www.ndp.gov.sg/resources/advisories/" },
      { name: "The Independent SG — NDP eases guidelines after public concerns", url: "https://theindependent.sg/singapore-national-day-parade-eases-guidelines-after-public-concerns/" },
    ],
    time: "2026년 8월 7일",
    isBreaking: true,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "🦟 뎅기열 8주 연속 100건↑ — 8월 1일 기준 17개 클러스터, 연간 누적 1,700건 돌파",
    summary: "8월 1일 마감 주간 뎅기열 확진 119건으로 8주 연속 100건 이상 발생 중이다. 활성 클러스터 17개(그중 6개 블랙스팟). 렌터 애비뉴·컨트리사이드 로드 클러스터는 228건에 달하는 급성장 핫스팟이다. 2026년 연간 누적 확진은 1,700건을 넘어섰다.",
    fullContent: `**뎅기열 8월 현황 (2026년 8월 1일 기준)**
국가환경청(NEA) 집계 기준, 뎅기 확진이 8주 연속 100건 이상을 기록하고 있습니다.

**주간 현황 (8/1 마감)**
- 당주 확진: **119건** (8주 연속 100건 이상)
- 활성 클러스터: **17개** (그중 **6개 블랙스팟**)
- 연간 누적: **1,700건 초과**

**주의 클러스터**
- **렌터 애비뉴/컨트리사이드 로드**: 228건 — 빠르게 성장 중인 대규모 핫스팟

**한인 가정 예방 수칙**
- 화분 받침대·에어컨 응결수 고인 물 즉시 제거
- 발코니 배수구 주 1회 청소
- 고열·관절통·두통 시 NEA 클러스터 지도에서 거주지 근처 확인

실시간 클러스터 위치는 NEA myENV 앱에서 확인하세요.`,
  ...
  },
  {
    ...
    title: "💵 GSTV 캐시 8월 6일부터 지급 — 시민권자 150만 명, 최대 S$850·PayNow·은행이체·GovCash",
    summary: "싱가포르 재무부(MOF) 발표: GST 바우처(GSTV) 현금이 8월 6일부터 순차 지급된다. 대상은 싱가포르 시민권자(21세 이상, 연과세소득 S$3만9,000 이하, 부동산 1채 이하). 연간가치(AV) S$2만1,000 이하 시 S$850, AV S$2만1,001~3만1,000 시 S$450. PayNow 연동 시 즉시, 은행이체 8/15, GovCash 8/22. PR·EP·DP는 해당 없음.",
    fullContent: `**GSTV 캐시(GST Voucher — Cash) 2026년 8월 지급**
싱가포르 재무부(MOF)가 발표한 GSTV 현금 지급 일정입니다.

**지급 대상 및 금액**
- 대상: 싱가포르 **시민권자** (21세 이상, 연과세소득 YA2025 기준 S$39,000 이하, 최대 주택 1채 보유)
- 약 **150만 명** 수혜 예정
- 연간가치(Annual Value) **≤S$21,000**: **S$850**
- 연간가치 **S$21,001~S$31,000**: **S$450**
- ⚠️ PR·EP·DP 비자 보유자는 해당 없음

**수령 방법 및 일정**
- **PayNow 연동**: 8월 6일부터 즉시 수령 (자동 지급)
- **은행 계좌 이체**: 8월 15일
- **GovCash**: 8월 22일 (PayNow·은행 미연동 시)

**추가: 시니어 MediSave 적립**
- 시니어 약 71만 명: 8월 11일부터 MediSave 추가 적립 S$150~450

정확한 수급 자격·금액은 아래 출처를 확인하세요.`,
    source: "MOF · ClearTax SG",
    sources: [
      { name: "MOF — 1.5 million adult Singaporeans to receive up to $850 in GSTV-Cash", url: "https://www.mof.gov.sg/news-resources/newsroom/1-5-million-adult-singaporeans-to-receive-up-to--850-in--gstv---cash-and-710-000-singaporean-seniors-to-receive-up-to--450-medisave-top-up-in-august-2026/" },
      { name: "ClearTax SG — GST Voucher Singapore", url: "https://www.cleartax.com/sg/en/gst-voucher-singapore" },
    ],
    time: "2026년 8월 6일~",
    isBreaking: false,
    readTime: "3분",
  ...
  },
  {
    ...
    category: "경제",
    catStyle: "bg-[#EBF0FB] text-[#2050A0]",
    title: "💱 MAS 7월 27일 두 번째 '깜짝 긴축' — SGD 절상 속도 소폭 상향, 2026년 인플레 전망 1.5~2.5%",
    summary: "MAS가 7월 27일 임시 통화정책성명을 발표해 S$NEER 정책밴드의 절상 속도를 소폭 높였다(폭·중심점 유지). 4월 긴축에 이은 두 번째 '깜짝 긴축'. 배경은 중동 유가 상승과 강한 GDP(Q2 +5.7%), 긍정적 아웃풋 갭. 2026년 근원물가 전망 1.5~2.5%, 2027년 중반 이후 완화 예상. SGD 강세는 한국 송금 시 유리.",
    fullContent: `**MAS 7월 27일 임시 통화정책성명 — 두 번째 긴축**
싱가포르 통화청(MAS)이 4월에 이어 7월 27일 두 번째 임시 정책 긴축을 발표했습니다. 환율에 민감한 한인에게 중요한 소식입니다.

**무엇이 바뀌었나**
- S$NEER 정책밴드의 **절상(appreciation) 속도를 소폭 상향** (밴드의 폭·중심점은 유지)
- SGD가 기존보다 더 빠르게 강세가 된다는 의미

**배경**
- 중동 유가 상승 → 수입 물가 압력 증가
- Q2 GDP +5.7% (2026년 상반기 강한 성장)
- 긍정적 아웃풋 갭(생산능력 상회) → 물가 압력 지속

**물가 전망**
- 2026년 근원물가(Core Inflation) 전망: **1.5~2.5%** (2027년 중반 이후 평년 수준 완화 예상)

**한인 참고 — 송금에 유리**
- SGD 강세 기조 → 싱가포르에서 **한국으로 송금할 때 더 많은 원화 수령 가능**
- 환율 알림 설정(Wise·Instarem 등)으로 유리한 시점 포착 권장

정확한 정책 내용은 MAS 공식 성명(아래 출처)을 확인하세요.`,
    source: "MAS · CNBC · The Edge Singapore",
    sources: [
      { name: "MAS — Monetary Policy Statement 27 Jul 26", url: "https://www.mas.gov.sg/news/monetary-policy-statements/2026/mas-monetary-policy-statement-27jul26" },
      { name: "CNBC — Singapore MAS July monetary policy", url: "https://www.cnbc.com/2026/07/27/singapore-mas-july-monetary-policy-middle-east-oil-prices-inflation-.html" },
  ...
  },
  {
    ...
    category: "교통",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "🚖 Grab·Gojek·Tada·CDG Zig 유류할증료 9월 30일까지 연장 — Grab·Gojek S$0.90, Tada 최대 S$1.20",
    summary: "주요 차량공유 플랫폼 4개사가 유류할증료를 7월 31일 이후에도 9월 30일까지 연장했다. Grab·Gojek S$0.90/탑승, Tada S$0.90(요금 S$18 미만) 또는 S$1.20(S$18.10 이상). 할증료 수익은 100% 기사에게 귀속, 플랫폼 수수료 없음. 중동 유가 상승이 배경.",
    fullContent: `**차량공유 유류할증료 9월 30일까지 연장**
싱가포르 주요 차량공유 4개사가 유류할증료를 연장했습니다.

**할증료 내역 (2026년 9월 30일까지)**
- **Grab**: S$0.90/탑승
- **Gojek**: S$0.90/탑승
- **Tada**: S$0.90 (탑승 요금 ≤S$18) 또는 S$1.20 (≥S$18.10)
- **CDG Zig(ComfortDelGro)**: 9월 30일까지 연장

**배경 및 기타**
- 중동 정세발 유가 상승이 원인
- 할증료 수익은 **100% 기사 귀속** (플랫폼 수수료 없음)

앱 내 최종 요금 확인 후 이용하세요.`,
