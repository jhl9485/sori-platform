...
const RAW_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    title: "🚨 경찰, 전섬 단속서 270명 검거 — 사기·자금세탁범 660건 이상, 피해액 S$540만",
    summary: "싱가포르 경찰(SPF)이 7월 30일~8월 12일 진행한 전국 합동 단속에서 사기 및 자금세탁 관련자 270명(남성 185명·여성 85명, 15~80세)을 조사했다. 이들에게는 660건 이상의 사기 관련 혐의가 적용됐으며 총 피해액은 S$540만에 달한다. 경찰은 피해를 당했거나 의심스러운 연락을 받은 경우 999(긴급) 또는 1800-722-0000으로 신고하도록 당부했다.",
    fullContent: `**싱가포르 경찰 전섬 단속 (2026년 7월 30일 ~ 8월 12일)**

SPF(싱가포르 경찰청)가 7월 30일부터 8월 12일까지 전섬 합동 단속 작전을 벌여 사기·자금세탁 관련자 **270명**(남 185명, 여 85명, 15~80세)을 조사했습니다.

**주요 수치**
- 조사 인원: **270명**
- 적용 혐의: **660건 이상** (사기, 자금세탁 등)
- 총 피해액: **S$540만** 이상

**피해자 대응 방법**
- 긴급: **999**
- 사기 신고 핫라인: **1800-722-0000**
- 온라인 신고: [www.police.gov.sg/iwitness](https://www.police.gov.sg/iwitness)

사기 피해 또는 의심 연락을 받은 경우 즉시 경찰에 신고하세요. 자금세탁(머니 뮬) 관련자도 형사 처벌 대상입니다.`,
    source: "SPF · AsiaOne",
    sources: [
      { name: "SPF 공식 보도자료", url: "https://www.police.gov.sg/Media-Hub/News/2026/08/20260813_police_investigate_270_scammers_and_money_mules_in_islandwide_enforcement_operation" },
      { name: "AsiaOne", url: "https://www.asiaone.com/singapore/police-investigating-270-scammers-money-mules" },
    ],
    time: "2026년 8월 13일",
    isBreaking: false,
    readTime: "2분",
    emoji: "🚨",
    relatedIds: ["auto-20260815-2", "auto-20260815-5"],
  },
  {
    id: "auto-20260815-2",
    ...
    category: "사회",
    catStyle: "bg-[#F5F0FF] text-[#7040C0]",
    title: "📱 iMessage 택배사 사칭 피싱 주의 — 'Y' 한 글자 답장으로 링크 보호 우회",
    summary: "SPF가 8월 5일 애플 iMessage를 이용한 택배사 사칭 피싱 수법에 대한 공개 경보를 발령했다. 6월 24일 이후 251건 신고, 피해액 S$120만 이상. 피해자가 'Y'(또는 'YES')를 답장하면 iMessage의 링크 보호 기능이 해제되며, 이후 표시된 링크를 클릭해 개인정보를 입력하면 피해가 발생한다. Ninja Van·J&T Express 등 실제 업체명을 도용한다. '배송 대기' 문자를 받으면 링크를 클릭하지 말고 공식 앱/웹사이트에서 직접 확인할 것.",
    fullContent: `**iMessage 택배사 사칭 피싱 (SPF 경보, 2026년 8월 5일)**

SPF가 애플 iMessage를 악용한 새 피싱 수법에 대한 공개 경보를 발령했습니다.

**수법 설명**
1. 모르는 번호로 iMessage가 도착 — Ninja Van·J&T Express 등 택배사를 사칭
2. "배송 대기 중, 링크를 클릭하세요" 등의 메시지
3. iMessage는 모르는 발신자의 링크를 기본 비활성화 — 그러나 사용자가 **'Y' 또는 'YES'를 답장하면 링크가 활성화**
4. 활성화된 링크 클릭 → 개인정보·카드번호 입력 → 피해 발생
...
**예방 요령**
- 낯선 번호의 iMessage에는 절대 답장하지 않는다
- 링크 클릭 대신 공식 앱·웹사이트에서 직접 조회
- 의심스러우면 1800-722-0000 신고`,
    source: "SPF · AsiaOne",
    sources: [
      { name: "SPF 공식 경보", url: "https://www.police.gov.sg/Media-Hub/News/2026/08/20260805_police_advisory_on_phishing_scams_impersonating_courier_companies_via_apple_imessage" },
      { name: "AsiaOne", url: "https://www.asiaone.com/singapore/over-s1-2m-lost-courier-phishing-scams-ninja-van-jt-express-imessage" },
    ],
    time: "2026년 8월 5일",
    isBreaking: false,
    readTime: "2분",
    emoji: "📱",
    relatedIds: ["auto-20260815-1", "auto-20260815-5"],
  },
  {
    id: "auto-20260815-3",
    ...
    title: "🌫️ 헤이즈 위험 상승 — PSI 81 기록, 태스크포스 PSI 100 돌파 대비",
    summary: "8월 9일 오전 싱가포르 중부 지역 PSI(오염표준지수)가 81을 기록하며 '나쁨(Unhealthy)' 직전 수준까지 올랐다. 수마트라·칼리만탄 지역 핫스팟 증가로 연무 위험이 높아지고 있으며, 싱가포르 정부 헤이즈 태스크포스는 PSI가 100을 넘을 경우 즉시 대응에 나선다는 계획이다. NEA는 야외 활동 자제와 N95 마스크 착용을 권고하고 있다.",
    fullContent: `**싱가포르 헤이즈 상황 (2026년 8월 10일 기준)**

8월 9일~10일 싱가포르 헤이즈 위험이 상승하고 있습니다.

**현재 수치**
- 8월 9일 오전 중부 지역 **PSI 81** (24시간 기준)
- PSI 101~200: '나쁨(Unhealthy)', 마스크 착용 권고 수준

**원인**
- 수마트라·칼리만탄(인도네시아) 핫스팟 증가
- 바람 방향이 싱가포르 쪽으로 연기 이동

**정부 대응**
- 헤이즈 태스크포스: PSI 100 초과 시 즉시 대응 준비
- NEA: 야외 활동 자제, 취약계층(어린이·노인·호흡기 환자) 실내 유지 권고

**실시간 확인**
- NEA 공식 앱 'myENV' 또는 [haze.gov.sg](https://haze.gov.sg) 에서 PSI 실시간 조회 가능

헤이즈가 심해지면 야외 활동과 운동을 자제하고, N95 마스크를 착용하세요.`,
    source: "AsiaOne · Malay Mail",
    sources: [
      { name: "AsiaOne", url: "https://www.asiaone.com/singapore/haze-situation-singapore-10-august-psi-reading" },
      { name: "Malay Mail", url: "https://www.malaymail.com/amp/news/singapore/2026/08/10/haze-risk-rises-singapore-task-force-ready-if-psi-tops-100/230772" },
    ],
    time: "2026년 8월 10일",
    isBreaking: true,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "건강",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "🦟 뎅기열 8주 연속 주간 100건 이상 — 누적 1,700건+, 17개 클러스터 활성화",
    summary: "8월 초 기준 싱가포르 뎅기열 주간 신규 확진이 8주 연속 100건을 상회했다. 올해 누적 확진자는 1,700건 이상이며, 17개 활성 클러스터 중 6곳이 레드얼럿(Red Alert) 상태다. 최대 클러스터는 Countryside Road/Lentor Avenue 일대로 228건에 달한다. NEA는 가정 내 고인 물 제거와 모기 기피제 사용을 강력 권고하고 있다.",
    fullContent: `**싱가포르 뎅기열 현황 (2026년 8월 초 기준)**

올해 싱가포르 뎅기열 상황이 심각합니다. 8주 연속 주간 신규 확진 100건 이상을 기록 중입니다.

**주요 수치**
- 주간 신규 확진: **8주 연속 100건 이상**
- 올해 누적 확진자: **1,700건 이상**
- 활성 클러스터: **17개** (이 중 6개 레드얼럿)
- 최대 클러스터: **Countryside Road / Lentor Avenue** — 228건

**레드얼럿 클러스터** (6곳)
— 거주지역 부근 클러스터 여부는 NEA 공식 웹사이트에서 확인 가능

**예방 행동요령**
- 가정 내 화분 받침·물통·막힌 배수구 등 **고인 물 제거** (주 1회 이상)
- 야외 활동 시 모기 기피제(DEET 함유) 사용
- 발열·관절통·발진 등 증상 시 즉시 의사 방문

**클러스터 확인**: [NEA 뎅기열 클러스터 페이지](https://www.nea.gov.sg/dengue-zika/dengue/dengue-clusters-under-surveillance)`,
    source: "The Independent SG · NEA",
    sources: [
      { name: "The Independent Singapore", url: "https://theindependent.sg/dengue-cases-fall-to-119-last-week-but-singapore-still-has-17-active-clusters/" },
      { name: "NEA 공식", url: "https://www.nea.gov.sg/dengue-zika/dengue/dengue-clusters-under-surveillance" },
    ],
    time: "2026년 8월",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "사회",
    catStyle: "bg-[#F5F0FF] text-[#7040C0]",
    title: "📲 텔레그램 계정 탈취 사기 — 대중교통 바우처 미끼로 OTP 입력 유도",
    summary: "싱가포르 경찰이 8월 13일 텔레그램 계정 탈취 피싱 수법에 대한 경보를 발령했다. 사기범들은 무료 대중교통 바우처 지급을 미끼로 링크를 전송하고, 피해자가 클릭해 OTP(일회용 비밀번호)를 입력하면 텔레그램 계정이 탈취된다. 탈취된 계정은 피해자의 지인에게 사기를 전파하는 데 사용된다. 아는 사람에게 바우처 관련 링크를 받더라도 절대 OTP를 입력하지 말 것.",
    fullContent: `**텔레그램 계정 탈취 사기 (SPF 경보, 2026년 8월 13일)**

SPF가 텔레그램 계정을 탈취하는 피싱 사기 수법에 대해 경보를 발령했습니다.

**수법**
1. 텔레그램을 통해 '무료 대중교통 바우처'를 미끼로 한 링크 전송
2. 피해자가 링크 클릭 → 가짜 페이지에서 **텔레그램 로그인 OTP 입력** 요청
3. OTP 입력 시 **텔레그램 계정 즉시 탈취**
4. 탈취된 계정으로 피해자의 연락처에 같은 사기 메시지 전송 → 피해 확산

**핵심 주의사항**
- 텔레그램 OTP를 **어떤 사이트에도 절대 입력하지 않는다**
- 아는 사람에게 링크를 받아도 의심하고 확인한다
- 계정이 탈취됐다면 즉시 텔레그램 설정에서 모든 세션 로그아웃

**신고**: 1800-722-0000 또는 [www.police.gov.sg/iwitness](https://www.police.gov.sg/iwitness)`,
    source: "AsiaOne · The Star",
    sources: [
      { name: "AsiaOne", url: "https://www.asiaone.com/singapore/police-fake-public-transport-voucher-scheme-phishing-telegram" },
      { name: "The Star", url: "https://www.thestar.com.my/aseanplus/aseanplus-news/2026/08/13/singapore-police-warn-of-compromised-telegram-accounts-in-fake-public-transport-voucher-scam" },
    ],
    time: "2026년 8월 13일",
    isBreaking: true,
    readTime: "2분",
    emoji: "📲",
    relatedIds: ["auto-20260815-1", "auto-20260815-2"],
  },
  {
    id: "auto-20260725-1",
