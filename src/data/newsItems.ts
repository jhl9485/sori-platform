...
const RAW_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    title: "🚨 ICA·중국 관리 사칭 사기 — 1월 이후 72건·S$610만 피해, SPF 8월 14일 경보",
    summary: "싱가포르 경찰청(SPF)이 8월 14일 ICA(이민국)·중국 당국 관리를 사칭한 사기 경보를 발표했다. 올해 1월 이후 72건 발생해 피해액이 최소 S$610만에 달한다. 전화로 ICA 직원을 사칭해 '개인정보 오용·범죄 연루'를 주장한 후 중국 수사관을 사칭한 사기범에게 전화를 넘겨 현금·금·암호화폐 이체를 요구하는 수법이다.",
    fullContent: `**ICA·중국 관리 사칭 사기 경보 (SPF, 2026년 8월 14일)**
싱가포르 경찰청(SPF)이 ICA(이민국) 직원 및 중국 당국 관리를 사칭한 사기에 대해 긴급 경보를 발령했습니다.

**피해 현황**
- 2026년 1월~8월: 총 **72건**, 피해액 최소 **S$610만**
- 피해자 1인 평균 약 S$8만5천 수준

**수법**
- 전화로 ICA 직원을 사칭해 "당신의 개인정보가 범죄에 악용됐다"고 주장
- 이후 중국 수사관·판사를 사칭한 사기범으로 전화를 넘겨 현금·금·암호화폐 이체 요구
- "국제 범죄 조사에 협조하라"며 비밀 유지를 요구하는 것이 특징

**SPF 주의 사항**
- 정부 기관(ICA·SPF 등)은 전화로 송금·개인정보를 요구하지 않음
- 의심 시 전화를 끊고 공식 번호(SPF: 1800-255-0000)로 직접 확인
- ScamShield 앱·1799(안티스캠 핫라인) 활용

정확한 경보 내용은 아래 SPF 공식 자료를 확인하세요.`,
    source: "SPF (공식) · AsiaOne",
    sources: [
      { name: "SPF — ICA·중국 관리 사칭 사기 경보 (공식)", url: "https://www.police.gov.sg/Media-Hub/News/2026/08/20260814_police_advisory_on_government_officials_impersonation_scams_involving_impersonation" },
      { name: "AsiaOne — ICA, China official impersonation scams: 72 cases since January, at least $6.1m", url: "https://www.asiaone.com/singapore/police-advisory-ica-china-official-impersonation-scam" },
      { name: "Yahoo News SG — At least $6.1m lost in seven months", url: "https://sg.news.yahoo.com/least-6-1m-lost-seven-143000105.html" },
    ],
    time: "2026년 8월 14일",
    isBreaking: true,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "사회",
    catStyle: "bg-[#F5F0FF] text-[#7040C0]",
    title: "💻 링크드인 가짜 채용→악성코드 '크립토 사기' — SPF·CSA, 약 S$1,500만 피해 (8/14 합동 경보)",
    summary: "싱가포르 경찰청(SPF)과 사이버보안청(CSA)이 8월 14일 가짜 채용 면접을 이용한 암호화폐 기업 대상 사이버 사기 합동 경보를 발표했다. 링크드인에서 가짜 채용담당자가 접근해 악성코드가 담긴 '기술 과제'를 다운받게 한 뒤 내부 서버에 침입, 암호화폐를 탈취하는 수법이며 피해액은 미화 약 1,180만 달러(약 S$1,500만)에 달한다.",
    fullContent: `**가짜 채용·악성코드 암호화폐 사기 (SPF·CSA 합동 경보, 2026년 8월 14일)**
싱가포르 경찰청(SPF)과 사이버보안청(CSA)이 합동으로 암호화폐 기업을 표적으로 한 사이버 사기 경보를 발표했습니다.

**피해 현황**
- 총 피해액: 미화 약 **1,180만 달러**(약 **S$1,500만**)

**수법**
- 링크드인에서 가짜 채용담당자가 접근해 채용 제안
- 악성코드가 삽입된 '기술 과제' 파일(GitHub 또는 일반 링크) 다운로드 유도
- 피해자가 파일을 실행하면 내부 시스템에 침투, 암호화폐 지갑·서버 탈취

**대응 요령**
- 채용 과정 중 출처 불명 파일 실행 금지
- 업무용 기기와 개인 기기 분리 운용
- 의심스러운 채용 접근은 회사 보안팀에 즉시 보고

암호화폐·핀테크 업계 종사 한인이라면 각별히 주의하세요. 정확한 경보 내용은 아래 출처를 확인하세요.`,
    source: "SPF·CSA (공식) · AsiaOne",
    sources: [
      { name: "SPF·CSA — Cryptocurrency Scams Involving Fake Job Offers and Compromised Software Systems (공식)", url: "https://www.police.gov.sg/Media-Hub/News/2026/08/20260814_spf_csa_joint_advisory_on_cryptocurrency_scams_involving_fake_job_offers" },
      { name: "AsiaOne — Over $15m lost to crypto scam involving fake job offers", url: "https://www.asiaone.com/singapore/15m-lost-crypto-scam-fake-job-software-csa-spf" },
      { name: "CryptoTimes — Singapore's SPF & CSA Report $11.8M Losses From Crypto Job Scams", url: "https://www.cryptotimes.io/2026/08/14/singapores-spf-csa-report-11-8m-losses-from-crypto-job-scams/" },
    ],
    time: "2026년 8월 14일",
    isBreaking: true,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "사회",
    catStyle: "bg-[#F5F0FF] text-[#7040C0]",
    title: "📦 아이폰 iMessage 택배 사칭 피싱 — 251건·S$120만, '회신하면 링크 활성화' 수법 주의",
    summary: "6월 24일 이후 Apple iMessage를 통해 DHL·닌자밴·J&T 등 택배사를 사칭하는 피싱 사기가 251건 발생해 총 S$120만 이상이 피해를 입었다고 SPF가 8월 5일 경보했다. 아이폰에서 모르는 발신자 링크를 차단하는 iMessage 보호 기능을 우회하기 위해 'Y'나 '1'로 회신하도록 유도하는 것이 특징이다.",
    fullContent: `**iMessage 택배사 사칭 피싱 사기 경보 (SPF, 2026년 8월 5일)**
싱가포르 경찰청(SPF)이 Apple iMessage를 통해 택배사를 사칭하는 피싱 사기 경보를 발표했습니다.

**피해 현황**
- 2026년 6월 24일 이후: **251건** 발생, 피해액 총 **S$120만 이상**

**수법**
- DHL·닌자밴(Ninja Van)·J&T 등 택배사를 사칭해 "배송 완료 실패" 문자 발송
- 아이폰은 모르는 발신자 링크를 기본적으로 차단하므로, 사기범이 'Y' 또는 '1'로 회신하도록 유도
- 회신하면 링크가 활성화되고 클릭 시 피싱 사이트로 유도, 금융정보 탈취

**주의 포인트**
- 모르는 발신자 iMessage의 링크는 클릭 금지
- 'Y', '1' 등 회신하면 보호 기능이 해제됨 — 절대 회신 금지
- 의심 배송 알림은 앱·공식 사이트에서 직접 조회

정확한 경보 내용은 아래 출처를 확인하세요.`,
    source: "SPF (공식) · AsiaOne · HardwareZone",
    sources: [
      { name: "SPF — iMessage 택배사 사칭 피싱 경보 (공식)", url: "https://www.police.gov.sg/Media-Hub/News/2026/08/20260805_police_advisory_on_phishing_scams_impersonating_courier_companies_via_apple_imessage" },
      { name: "AsiaOne — Over $1.2m lost to courier phishing scams via iMessage", url: "https://www.asiaone.com/singapore/over-s1-2m-lost-courier-phishing-scams-ninja-van-jt-express-imessage" },
      { name: "HardwareZone — Courier missed delivery iMessage scam", url: "https://www.hardwarezone.com.sg/lifestyle/apps/courier-missed-delivery-imessage-scam" },
    ],
    time: "2026년 8월 5일",
    isBreaking: true,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "🌫️ 연무 '보통' 수준 지속, NEA 헤이즈대응팀 경계 태세 — PSI 70~81, 8~9월 악화 가능성",
    summary: "8월 9일 국경일 오후 싱가포르 중부 24시간 PSI가 81까지 올랐다가 10일 70대로 내려갔다. NEA 헤이즈대응팀은 PSI가 100을 넘으면 즉시 헤이즈 일별 경보를 발령하겠다고 밝혔다. 엘니뇨로 인도네시아·수마트라·칼리만탄에서 대규모 산불이 지속되고 있으며, 8~9월이 피크 위험 구간이다.",
    fullContent: `**연무(헤이즈) 현황 & NEA 헤이즈대응팀 (2026년 8월 10일)**
싱가포르 국립환경청(NEA)이 연무 상황과 헤이즈대응팀 가동 준비 태세를 발표했습니다.

**현재 상황**
- 8월 9일(국경일) 오후 24시간 PSI 중부 기준 **81** 기록 (보통 구간)
- 8월 10일 기준 **70대**로 완화, '보통(Moderate)' 수준 유지
- NEA: "계속적인 월경성 연무(transboundary haze) 위험" 경고

**헤이즈대응팀(Haze Task Force)**
- PSI 100 초과 시 **즉시 헤이즈 일별 경보** 발령 체제 준비
- NEA·MOH·MSS·교육부 등 관계기관 협력 체제

**배경 및 전망**
- 엘니뇨로 인도네시아 수마트라·칼리만탄 산불 지속
- 건조한 날씨 탓에 **8~9월이 연무 위험 피크 구간**
- 클라우드 시딩(인공강우)은 현 엘니뇨 조건에서는 효과 제한적

**한인 참고**
- PSI 101~200(불건강) 구간 진입 시 야외활동 자제, N95 마스크 착용
- 어린이·노인·기저질환자는 PSI 보통 구간에도 주의 필요
- NEA 사이트·앱(myENV)에서 실시간 PSI 확인 가능

정확한 수치와 경보는 아래 출처를 확인하세요.`,
    source: "NEA · MalayMail · AsiaOne · Mothership",
    sources: [
      { name: "MalayMail — Haze risk rises: Singapore task force ready if PSI tops 100", url: "https://www.malaymail.com/news/singapore/2026/08/10/haze-risk-rises-singapore-task-force-ready-if-psi-tops-100/230772" },
      { name: "AsiaOne — 24-hour PSI remains in moderate range; NEA says 'continued risk of transboundary haze'", url: "https://www.asiaone.com/singapore/haze-situation-singapore-10-august-psi-reading" },
      ...
      { name: "TechTimes — Indonesia Haze Strikes Malaysia and Singapore as El Nino Disables Cloud Seeding", url: "https://www.techtimes.com/articles/323731/20260810/indonesia-haze-strikes-malaysia-singapore-el-nino-disables-cloud-seeding.htm" },
    ],
    time: "2026년 8월 10일",
    isBreaking: false,
    readTime: "2분",
    emoji: "🌫️",
    relatedIds: ["auto-20260624-5"],
  },
  {
    id: "auto-20260818-5",
    publishedAt: "2026-08-05",
    category: "건강",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "🦟 뎅기 주간 119건·17개 활성 클러스터 — 2026년 누적 1,700건+, 피크 시즌 한창",
    summary: "8월 1일 기준 주(週) 뎅기열 확진이 119건으로 8주 연속 100건 이상을 기록하고 있다. 2026년 누적 확진이 1,700건을 넘어섰고, 활성 클러스터 17곳 중 컨트리사이드 로드/렌터 애비뉴 클러스터는 이미 228건을 기록 중이다. NEA는 모기 번식지 제거를 최우선으로 당부했다.",
    fullContent: `**뎅기열 현황 — 피크 시즌 (2026년 8월)**
국립환경청(NEA)이 2026년 8월 뎅기열 피크 시즌 진입을 선언하고 주의를 당부했습니다.

**최신 통계 (8월 1일 기준)**
- 최근 1주 확진: **119건** — **8주 연속 100건 이상**
- 2026년 누적 확진: **1,700건 이상**
- 활성 클러스터: **17곳**

**주요 클러스터**
- Countryside Road / Renter Avenue 클러스터: 이미 **228건** 기록 (최대 규모)
- Punggol·Tampines·Woodlands 지역도 활성 클러스터 포함

**예방 — 모기 번식지 제거가 핵심**
- 집 안팎 고인 물 제거(화분받침, 화병, 배수구 등)
- 주 1회 이상 '5단계 점검'(스프레이·뒤집기·교체·청소·화학처리)
- 증상(고열·관절통·발진)은 즉시 클리닉 방문

정확한 클러스터 위치·통계는 아래 출처(NEA·The Independent SG)를 확인하세요.`,
    source: "NEA · The Independent SG",
    sources: [
      ...
      { name: "The Independent SG — Dengue cases fall to 119 last week, but Singapore still has 17 active clusters", url: "https://theindependent.sg/dengue-cases-fall-to-119-last-week-but-singapore-still-has-17-active-clusters/" },
    ],
    time: "2026년 8월",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "📋 MOM COMPASS C1 급여 벤치마크 2027년판 공개 — 평균 5% 인상, EP 준비자 사전 점검 필요",
    summary: "MOM이 2026년 8월 2027년도 EP COMPASS C1 급여 벤치마크를 갱신 발표했다. 2027년 1월 1일 이후 신규 EP 신청 및 2027년 7월 1일 이후 만료 갱신 건에 적용된다. 섹터별 65th 퍼센타일 기준값이 평균 약 5.11% 인상됐으며, 펀드매니지먼트 분야가 9.91%로 최대 인상폭이다. EP 만료가 2027년 하반기인 한인 직장인은 지금부터 점수를 사전 점검해야 한다.",
    fullContent: `**MOM COMPASS C1 급여 벤치마크 2027년판 (2026년 8월 발표)**
MOM이 2027년도 Employment Pass(EP) COMPASS C1 기준 급여 벤치마크를 발표했습니다. EP 만료가 가까운 한인 직장인에게 중요한 정보입니다.

**적용 시점**
- **2027년 1월 1일 이후** 신규 EP 신청 건부터 적용
- **2027년 7월 1일 이후** 만료되는 갱신 건부터 적용

**벤치마크 인상 규모**
- 전 섹터 평균 약 **5.11% 인상**
- 최대 인상: 펀드매니지먼트 **+9.91%**
- 주요 섹터: IT(약 +4%), 금융(약 +5%), 전문서비스(약 +6%)

**COMPASS C1 점수 구조**
- 급여가 해당 섹터 65th 퍼센타일 이상 → 10점 / 40th~65th → 5점 / 40th 미만 → 0점
- C1 점수는 40점 만점 COMPASS에서 최대 20점까지 반영

**한인 체크리스트**
- EP 만료가 2027년 하반기라면 지금부터 MOM myMOM 포털에서 COMPASS 자가점검 실시
- 섹터별 벤치마크는 매년 갱신되므로 갱신 신청 전 반드시 최신 기준으로 확인
- 급여 인상이 어렵다면 C2(다양성)·C4(기술인증) 점수 보완으로 40점 달성 가능

정확한 섹터별 수치는 아래 출처를 확인하세요.`,
    source: "Human Resources Online · Fragomen · Erickson Immigration",
    sources: [
      { name: "Human Resources Online — Singapore announces further updates to COMPASS C1 salary benchmarks", url: "https://www.humanresourcesonline.net/singapore-announces-further-updates-to-compass-c1-salary-benchmarks-for-employment-pass-applications" },
      { name: "Fragomen — Singapore: New Salary Benchmarking Table by Sector Now Available", url: "https://www.fragomen.com/insights/singapore-new-salary-benchmarking-table-by-sector-now-available.html" },
      { name: "Erickson Immigration Group — Singapore Updates COMPASS C1 Salary Benchmarks", url: "https://eiglaw.com/singapore-updates-compass-c1-salary-benchmarks-for-employment-pass-applications/" },
    ],
    time: "2026년 8월",
    isBreaking: false,
    readTime: "2분",
