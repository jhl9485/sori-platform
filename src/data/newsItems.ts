...
const RAW_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    title: "💱 MAS 통화정책 '두 번째 긴축' — SGD 절상속도 소폭 인상, 2026년 근원물가 1.5~2.5% 전망",
    summary: "MAS(싱가포르 중앙은행)는 7월 27일 임시 성명에서 SGD 명목실효환율(S$NEER) 정책밴드의 절상 기울기(appreciation slope)를 소폭 높인다고 발표했다. 밴드 폭·중심값은 동결. 이는 2026년 4월에 이은 두 번째 긴축이다. 2026년 근원물가 전망을 1.5~2.5%(종전 1.0~2.0%)로 상향하고, 에너지·수입물가 압력이 당분간 지속된다고 진단했다.",
    fullContent: `**MAS 2026년 7월 통화정책 성명 요약**
MAS(싱가포르 금융관리국)가 7월 27일 임시 통화정책 성명을 발표했습니다. 한국 송금·환율에 직접 영향을 미치는 내용입니다.

**정책 변화**
- SGD 명목실효환율(S$NEER) 정책밴드 **절상 기울기(slope) 소폭 인상**
- 밴드 폭(width)과 중심값(centre)은 **동결**
- 이는 2026년 4월 긴축에 이은 **두 번째 연속 긴축**

**물가 전망 상향**
- 2026년 **근원물가(MAS Core Inflation) 전망: 1.5~2.5%** (기존 1.0~2.0%에서 상향)
- 2026년 **CPI 전망: 1.5~2.5%** (기존 1.0~2.0%)
- 주요 원인: **에너지 가격 상승**(중동 지정학적 긴장), **수입 비용 압력 지속**

**성장 전망**
- 2026년 GDP 성장률 전망 **1~3%** 유지

**한인 참고**
- SGD 강세 기조 → **한국 송금 시 상대적으로 유리**
- 환율 변동 알림: Wise·Instarem 등 앱 활용 권장
- SORI 홈 실시간 환율 위젯에서 현재 SGD/KRW 시세 확인 가능

정확한 정책 내용은 아래 MAS 공식 자료를 반드시 확인하세요.`,
    source: "MAS",
    sources: [
      { name: "MAS — 통화정책성명 2026년 7월 27일", url: "https://www.mas.gov.sg/news/monetary-policy-statements/2026/mas-monetary-policy-statement-27jul26" },
      { name: "MAS — Macroeconomic Review Vol.XXV Issue 3 (Jul 2026)", url: "https://www.mas.gov.sg/publications/macroeconomic-review/2026/volume-xxv-issue-3-jul-2026" },
    ],
    time: "2026년 7월 27일",
    isBreaking: false,
    readTime: "3분",
  ...
  },
  {
    ...
    category: "경제",
    catStyle: "bg-[#EBF0FB] text-[#2050A0]",
    title: "🇦🇺 싱-호주 '필수물자·방위물자 무역 협약' 체결 — 경유·LNG 수출 제한 금지 약속",
    summary: "7월 27일 애들레이드에서 열린 제15차 싱가포르-호주 장관급 회의(SAJMC)에서 양국이 'SAFTA 경제회복력·필수물자 의정서'에 서명했다. 싱가포르가 호주에 공급하는 휘발유 55%·경유 15%·항공유 23%에 대해 호주가 수출 제한을 하지 않겠다고 약속하고, 싱가포르도 호주에 방위물자 공급을 보장한다. AI·사이버 안보 협력도 강화.",
    fullContent: `**싱가포르-호주 필수물자·방위물자 무역 협약 체결**
2026년 7월 27일 호주 애들레이드에서 열린 제15차 싱가포르-호주 장관급 회의(SAJMC)에서 중요한 경제·안보 협약이 체결되었습니다.

**협약 핵심 내용**
- **'경제회복력·필수물자 의정서(Protocol on Economic Resilience and Essential Supplies)'** 서명
- 기존 싱가포르-호주 자유무역협정(SAFTA) 산하 새 의정서
- 호주 → 싱가포르: **경유·LNG 수출 제한 금지** 약속
- 싱가포르 → 호주: **방위 물자 공급** 보장

**현재 양국 에너지 교역 규모**
- 싱가포르 → 호주 **휘발유 공급의 55%**, **경유 15%**, **항공유 23%**
- 지정학적 불안정(중동 등) 속 에너지 안보 강화 목적
...
**한인 참고**
- 주유비·항공권 가격과 연관된 에너지 공급 안정화 노력
- 글로벌 공급망 리스크가 싱가포르 물가에 미치는 영향 완화 기대

정확한 내용은 아래 공식 보도자료를 확인하세요.`,
    source: "호주 외교부 · 호주 국방부",
    sources: [
      { name: "호주 외교부 — 필수물자 의정서 서명", url: "https://www.foreignminister.gov.au/minister/penny-wong/media-release/australia-and-singapore-sign-landmark-protocol-economic-resilience-and-essential-supplies" },
      { name: "호주 국방부 — 방위물자 협약", url: "https://www.minister.defence.gov.au/media-releases/2026-07-27/australia-singapore-sign-landmark-protocol-economic-resilience-essential-supplies" },
    ],
    time: "2026년 7월 27일",
    isBreaking: false,
    readTime: "3분",
  ...
  },
  {
    ...
    title: "🏢 URA 2분기 부동산 확정 통계 — 집값 +0.5%(7분기 연속↑), 렌트 +0.7%로 재상승",
    summary: "URA가 7월 24일 발표한 2분기 확정 통계: 민간 주택가격 +0.5%(7분기 연속 상승). 단독·반단독·테라스(Landed) +2.5%, 비(非)Landed -0.1%. 렌트는 +0.7%로 재상승(Landed +2.7%, 非Landed +0.4%). 공실률 6.4%(전분기 6.2%에서 상승). 재판매 거래 3,813건.",
    fullContent: `**URA 2026년 2분기 민간 주택시장 확정 통계**
URA(도시재개발청)가 7월 24일 2분기 민간 주택시장 확정 통계를 발표했습니다. 한인 임차인·매매 고려자에게 참고 정보입니다.

**가격 동향**
- 전체 민간 주택 가격지수: 전분기比 **+0.5%** (2024년 4분기 이후 **7분기 연속 상승**)
- **Landed(단독·반단독·테라스): +2.5%** (큰 폭 상승)
- **Non-Landed(아파트·콘도): -0.1%** (소폭 하락)

**임대료 동향**
- 전체 임대료: 전분기比 **+0.7%** (하락세에서 반등)
- Landed: **+2.7%** / Non-Landed: **+0.4%**

**기타 지표**
- 공실률: **6.4%** (전분기 6.2%에서 상승)
- 2분기 재판매 거래: **3,813건**
- 신규 분양(1차 시장) 판매: 별도 통계 참고

**한인 참고**
- 콘도 임대료는 소폭 반등 — 계약 갱신 시 협상 여지 점검
- Landed 가격·렌트 급등은 주로 고가 단독주택 영향 — 한인 다수 거주 콘도는 비교적 안정

정확한 지표·세부 데이터는 아래 URA 공식 자료를 확인하세요.`,
    source: "URA · 99.co",
    sources: [
      { name: "URA — 2분기 민간 주택시장 통계 (확정)", url: "https://www.ura.gov.sg/news/media/pr26-57/" },
      { name: "99.co — Q2 2026 집값 분석", url: "https://www.99.co/singapore/insider/singapore-private-home-prices-q2-2026-report-breakdown/" },
      { name: "Yahoo News SG — 렌트 재상승", url: "https://sg.news.yahoo.com/private-residential-rents-rise-0-073000846.html" },
    ],
    time: "2026년 7월 24일",
    isBreaking: false,
    readTime: "3분",
  ...
  },
  {
    ...
    title: "🚕 Grab·Gojek·Tada·CDG Zig 유류할증료 9월 30일까지 재연장 — 최대 S$1.20 추가 요금 지속",
    summary: "NPHVA(민간고용차량협회) 발표: 7월 31일 종료 예정이던 4개 플랫폼(Grab·Gojek·Tada·CDG Zig)의 유류할증료를 9월 30일까지 재연장. Grab·Gojek S$0.90, Tada S$0.90~1.20, CDG Zig S$0.50~0.80. 중동 지정학 긴장에 따른 유가 상승이 원인.",
    fullContent: `**Grab·Gojek·Tada·CDG Zig 유류할증료 9월 말까지 재연장**
라이드헤일링 앱을 자주 이용하는 한인 거주자 참고 정보입니다.

**연장 내용**
- **연장 기간: 2026년 9월 30일까지** (기존 7월 31일 종료 예정 → 연장)
- 발표 기관: NPHVA(National Private Hire Vehicle Association, 민간고용차량협회)

**플랫폼별 할증료**
| 플랫폼 | 할증료 | 비고 |
|---|---|---|
| **Grab** | S$0.90 | JustGrab·GrabCar 등(표준·미터 택시 제외) |
| **Gojek** | S$0.90 | |
| **Tada** | S$0.90~1.20 | 서비스 등급에 따라 상이 |
| **CDG Zig** | S$0.50~0.80 | |

**연장 이유**
- **중동 지정학적 긴장** 지속에 따른 **유가 상승**
- 기사 수입 실질 감소 보전 목적

**한인 참고**
- 택시·라이드헤일링 이용 시 할증료 자동 부과됨 — 요금 확인 후 탑승
- 요금이 부담될 경우 MRT·버스 등 대중교통 대안 검토

정확한 할증료·서비스 범위는 각 앱 또는 아래 출처를 확인하세요.`,
    source: "The Independent SG · The Star",
    sources: [
      { name: "The Independent SG — 유류할증료 9월 연장", url: "https://theindependent.sg/grab-gojek-tada-and-comfortdelgro-s-cdg-zig-extend-fuel-surcharges-through-sept-30-amid-rising-fuel-prices/" },
      { name: "The Star — 할증료 연장 보도", url: "https://www.thestar.com.my/aseanplus/aseanplus-news/2026/07/23/comfortdelgro-grab-gojek-tada-to-retain-additional-driver-fee-for-rides-in-singapore-till-sept-30" },
    ],
    time: "2026년 7월 22~23일",
    isBreaking: false,
    readTime: "2분",
    emoji: "🚕",
    relatedIds: ["auto-20260629-2"],
  },
  {
    id: "auto-20260729-5",
    ...
    category: "건강",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "🦟 뎅기 혈청형 'DENV-3' 급부상 — 1월 19%→6월 60%, 2분기 770건으로 1분기比 88% 급증",
    summary: "NEA 2분기 모기 감시 보고: DENV-3 혈청형이 1월 19.1%→6월 59.9%로 우점 혈청형이 됐다. 대규모 클러스터 증가 중. 상반기 전체 1,180건(2025년 상반기比 54% 감소)이나 2분기만 770건으로 1분기(410건)比 88% 급증. NEA, 모기 서식지 제거 강력 촉구.",
    fullContent: `**2026년 뎅기열 현황 — DENV-3 혈청형 급증 주의**
싱가포르 거주 한인 가정, 특히 어린이·임산부 있는 가정에서 주의가 필요한 건강 정보입니다.

**혈청형 변화 (핵심)**
- **DENV-3 혈청형**: 2026년 1월 **19.1%** → 6월 **59.9%** (급증, 우점 혈청형 등극)
- DENV-3는 **면역이 없는 인구 비율이 높아** 확산 속도가 빠를 수 있음
- 과거 DENV-1·2·4에만 노출된 사람은 DENV-3에 취약

**발생 현황**
- 2026년 상반기 총 **1,180건** (2025년 상반기 2,583건 比 **54% 감소**)
- 그러나 **2분기(4~6월) 770건** = 1분기(1~3월) **410건 대비 +88% 급증**
- 대규모 클러스터(뭉치 발생) 증가 추세

**NEA 주요 당부**
- 화분 받침·버킷 등 고인 물 **주 1회 이상 비우기**
- 에어컨 물받이·화분 흙 확인
- 모기 퇴치제(DEET 함유) 사용

**한인 참고**
- 야외 활동 시 긴 소매·바지 착용 및 모기 퇴치제 사용 권장
- 뎅기 의심 증상(고열·두통·근육통·발진): 즉시 GP·클리닉 방문
- GP 방문 전 CHAS 카드·보험 확인

정확한 발생 현황은 NEA 공식 뎅기 대시보드를 수시 확인하세요.`,
    source: "Yahoo News SG · NEA",
    sources: [
      { name: "Yahoo News SG — NEA 뎅기 경보", url: "https://sg.news.yahoo.com/nea-urges-action-to-prevent-mosquito-breeding-amidst-increasing-dengue-cases-in-large-clusters-singapore-070455496.html" },
      { name: "NEA — 뎅기 발생 현황", url: "https://www.nea.gov.sg/dengue-zika/dengue/dengue-cases" },
    ],
    time: "2026년 7월 21일",
    isBreaking: false,
    readTime: "3분",
