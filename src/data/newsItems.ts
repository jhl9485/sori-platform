...
const RAW_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    title: "🦟 뎅기열 2026 누적 1,700건 돌파 — 8주 연속 주간 100건 초과·17개 클러스터 활성화",
    summary: "NEA 집계 기준 8월 1일로 끝나는 주까지 주간 확진은 119건이나, 8주 연속 100건을 넘으며 2026년 누적 확진이 1,700건을 돌파했다. 현재 활성 클러스터 17곳 중 6곳이 블랙스팟으로, 북부 캔트리사이드로드·렌터 애비뉴 클러스터는 누적 228건의 대형 확산 지역이다.",
    fullContent: `**2026년 8월 뎅기열 현황 업데이트 (NEA)**
뎅기 시즌 피크(5~10월)가 이어지며 주의가 필요한 상황입니다.

**최신 수치**
- 8월 1일로 끝나는 주 신규 확진: **119건** (소폭 감소)
- **8주 연속** 주간 100건 이상
- 2026년 누적 확진: **1,700건 이상**

**클러스터 현황**
- 활성 클러스터: **17곳**
- 블랙스팟(누적 10건 이상 지정): **6곳**
- 주요 대형 클러스터:
  - **캔트리사이드로드/렌터 애비뉴(북부)**: 누적 **228건** (빠르게 확산 중)
  - **잘란 타리 둘랑/잘란 타리 파용**: 누적 **38건** (빠르게 확산 중)

**⚠️ 한인 가정 예방 수칙**
- 화분 받침대·에어컨 응결수 받이·양동이 등 실내외 고인 물 즉시 제거
- 북부(렌터·캔트리사이드·셈바왕 등) 거주 한인은 특히 주의
- 고열(38.5도+)·심한 두통·눈 뒤 통증·관절통이 3일 이상 지속되면 GP·폴리클리닉 방문 후 NS1 검사 요청
- 실시간 클러스터 위치는 **NEA myENV 앱** 또는 **haze.gov.sg** 에서 확인
...
정확한 내용은 원문(아래 출처)을 확인하세요.`,
  ...
  },
  {
    ...
    category: "날씨",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "🌫️ 연무 경보 — 8/9 PSI 81(보통), 건기·수마트라 화재로 이번 주 악화 가능 (NEA)",
    summary: "NEA가 8월 9일 오후 1시 기준 24시간 PSI 중부 지역 81(보통 범위 상위)을 기록 중이며, 건조한 날씨와 수마트라·칼리만탄 화재가 지속될 경우 이번 주 연무 위험이 더 높아질 수 있다고 경고했다. 정부 28개 기관 합동 헤이즈 태스크포스는 24시간 PSI가 100을 초과할 경우 즉시 가동될 준비 상태다.",
    fullContent: `**연무(헤이즈) 주의보 — 8월 9일 (NEA)**

**현황 (8월 9일 오후 1시 기준)**
- 24시간 PSI: 중부 지역 **81** (보통(Moderate) 범위 내 상위 수준)
- 전체 싱가포르는 보통 범위 유지 중

**원인 및 전망**
- 수마트라·칼리만탄 일부 지역에 화재 핫스팟·연기 기둥 확인
- **남동풍**이 연기를 싱가포르 방향으로 운반 가능
- 건조한 날씨가 이번 주도 지속되면 → 화재 증가 → PSI 상승 위험
- NEA: 상황 변화 시 추가 업데이트 발령, **24시간 PSI 100 초과 시** 28개 기관 헤이즈 태스크포스 즉시 가동

**배경**
- 6월 SIIA가 올해 연무 위험을 '레드(고위험)' 등급으로 경고하고 8~9월을 '피크 위험기'로 지목한 바 있음

**⚠️ 한인 행동 수칙**
- 외출 전 **NEA myENV 앱 / haze.gov.sg**에서 1시간 PM2.5·24시간 PSI 확인
- PSI 100 이상(비건강 범위) 시 야외 격렬 활동 자제, 어린이·노약자·호흡기 환자는 실내 유지 권장
- N95 마스크·공기청정기 미리 점검해두기
- 자녀 야외행사·운동회 계획 있으면 당일 PSI 확인 후 결정

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "NEA · The Star · Mothership",
    sources: [
      { name: "The Star — Risk of haze in Singapore if dry conditions, regional hot spots continue in the coming week (2026/08/09)", url: "https://www.thestar.com.my/aseanplus/aseanplus-news/2026/08/09/risk-of-haze-in-singapore-if-dry-conditions-regional-hot-spots-continue-in-the-coming-week" },
  ...
  },
  {
    ...
    title: "💵 MAS 7월 통화정책 — SGD 절상 속도 소폭 추가 인상·핵심물가 연간 1.5~2.5% 전망",
    summary: "싱가포르 통화청(MAS)이 7월 27일 S$NEER(싱가포르달러 명목실효환율) 정책밴드 절상 속도를 소폭 추가 인상했다(4월 조정보다 폭이 작음). 밴드 폭·중심 수준은 유지. 2026년 핵심물가·소비자물가 연간 전망 1.5~2.5%를 유지하며, 에너지 등 수입 물가 압력이 국내 소비자물가로 계속 전이될 것이라고 밝혔다.",
    fullContent: `**MAS 7월 2026 통화정책 성명 (7월 27일 발표)**
싱가포르 통화청(MAS)이 2026년 두 번째 통화정책 성명을 발표했습니다.

**결정 사항**
- **S$NEER 정책밴드 절상 속도(기울기) 소폭 추가 인상**
  - 4월 조정보다 인상 폭이 더 작음
  - 밴드의 폭(width)·중심 수준(centre level)은 변동 없음
- 올해 두 번째 긴축 조치 (4월에 이어)

**물가 전망**
- 2026년 **MAS 핵심물가(Core Inflation): 연 1.5~2.5%** (전망 유지)
- 에너지·가스 가격 상승 등 수입 비용이 국내 소비자물가로 광범위하게 전이될 전망
- 물가 완화는 **2027년 하반기**부터 더 뚜렷해질 것으로 예상

**한인 참고 (SGD/KRW 환율·송금)**
- SGD가 소폭 더 강세 방향으로 관리된다는 의미. 싱가포르달러 강세는 한국 송금 시 KRW 수령액이 유리해지는 방향
- 반면 에너지·수입 가격 상승으로 싱가포르 내 물가(외식·생활비 등)도 높게 유지될 수 있음
- 다음 통화정책 성명은 2026년 10월 예정
...
정확한 내용은 원문(아래 출처)을 확인하세요.`,
    ...
    sources: [
      ...
      { name: "Xinhua — Singapore tightens monetary policy as inflation risk persists", url: "https://english.news.cn/asiapacific/20260727/fd481b8a88a34ec292891e6a0fed85f9/c.html" },
    ],
    time: "2026년 7월 27일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "취업",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "👷 9월 1일부터 NTS 직종 목록 8개 신설 — 보육사·에두케어러·웨이터·객실 승무원 등 워크퍼밋 허용",
    summary: "인력부(MOM)가 9월 1일부터 비전통 출신국(NTS) 워크퍼밋 직종 목록(NTS-OL)에 사회서비스·음식서비스·항공 분야 8개 직종을 추가한다. 보육사·에두케어러·교사 보조원·정육사·식음료 스태프·주방 보조·웨이터·객실 승무원이 포함되며, 최소 월급여 S$2,000·전체 직원 8% 이내 조건을 충족해야 한다.",
    fullContent: `**NTS 직종 목록(NTS-OL) 확대 — 9월 1일 시행 (MOM)**
인력부(MOM)가 9월 1일부터 비전통 출신국(NTS) 워크퍼밋 직종 목록을 확대합니다. 한인 요식업주·보육이 필요한 가정에 관련된 정보입니다.

**추가되는 8개 직종 (9/1 발효)**

**사회서비스**
- 보육사·영아 돌봄 종사자 (Babysitters or infant caregivers)
- 에두케어러 (Educarers) — 영유아 교육·보육 통합 담당
- 교사 보조원 (Teacher aides)

**음식서비스**
- 정육사·어류 가공사 (Butchers, fishmongers and related food preparers)
- 식음료 스탠드·포장마차 스태프 (Food or drink stall assistants)
- 주방 보조 (Kitchen assistants)
- 웨이터·웨이트리스 (Waiters)

**항공**
- 객실 승무원 (Cabin attendants)

**고용주 요건**
- 최소 고정 월급여: **S$2,000 이상**
- NTS 직종 목록 채용 비율: **전체 직원의 8% 이내**

**NTS 출신국 (9개국)**
방글라데시·부탄·캄보디아·인도·라오스·미얀마·필리핀·스리랑카·태국

**한인 참고**
- 한인이 운영하는 음식점·식음료 사업장은 이번 확대로 주방·홀 직원 채용 선택지가 넓어집니다.
- 영유아를 키우는 가정에서 NTS 출신 보육사·에두케어러를 워크퍼밋으로 채용할 수 있게 됩니다.
- 기존 Work Permit 절차(MOM 신청·레비·외국인 근로자 보험 등)는 동일하게 적용됩니다.

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "MOM · Fragomen · Envoy Global",
    sources: [
      { name: "Fragomen — Singapore: Non-Traditional Sources Occupation List to be Expanded", url: "https://www.fragomen.com/insights/singapore-non-traditional-sources-occupation-list-to-be-expanded.html" },
      { name: "Envoy Global — Singapore Updates NTS Occupation List for Work Permit Holders", url: "https://www.envoyglobal.com/news-alert/singapore-updates-non-traditional-sources-nts-occupation-list-for-work-permit-holders/" },
      { name: "Mavenside — NTS Occupation List Expansion Sep 2026: 8 New Work Permit Roles", url: "https://www.mavenside.co/blog/singapore-expanded-nts-occupation-list-new-work-pass-pathways-september-2026" },
    ],
    time: "2026년 8월 (9월 1일 시행)",
    isBreaking: false,
    readTime: "2분",
    emoji: "👷",
    relatedIds: [],
