...
const RAW_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    title: "🚨 사기 근절 강화법안 의회 상정 — 경찰, 은행·통신사·플랫폼에 계좌 비활성화 명령권",
    summary: "내무부(MHA)가 8월 4일 '사기(대응조치) 법안(Scams (Countermeasures) and Other Matters Bill)'을 의회에 제출했다. 경찰이 은행·통신사·Carousell·TikTok 등 온라인 플랫폼에 특정 계좌 정보 공개를 요구하는 '공개명령'과 계좌를 최대 30일(1회 연장 추가 30일) 비활성화하는 '계좌비활성화명령'을 발령할 수 있게 된다. 플랫폼이 실행지침을 따르지 않으면 최대 S$1천만(기존 S$1백만) 벌금, 계속 위반 시 하루 S$30만(기존 S$10만). 타인 정보로 계좌 개설·명의 대여는 S$1만 이하 벌금·징역 3년·태형 12대.",
    fullContent: `**사기(대응조치) 법안 의회 1차 독회 (MHA, 2026년 8월 4일)**
싱가포르 내무부(MHA)가 사기 대응 권한을 획기적으로 강화하는 법안을 의회에 제출했습니다.

**새 경찰 권한 (2가지 명령)**
- **공개명령(Disclosure Order)**: 경찰이 은행·통신사·온라인 플랫폼에 사기와 연관된 특정 계좌 정보를 제출하도록 명령
- **계좌비활성화명령(Account Disabling Order)**: 사기 연루 의심 계좌를 **최대 30일** 비활성화 명령 가능 (1회 최대 30일 추가 연장 허용)

**플랫폼 위반 시 강화된 벌금**
- 온라인서비스사 최대 벌금: **S$1백만 → S$1천만**으로 10배 인상
- 계속 위반 시 하루 벌금: S$10만 → **S$30만**

**새 범죄: 계좌 명의 대여·공급**
- 범죄에 사용할 계좌 개설·제공·수령·명의 대여 → **최대 S$1만 벌금 + 징역 3년 + 태형 12대**
- Carousell·TikTok 등 SNS·마켓플레이스 계정 포함 (온라인 계좌 뮬(mule) 처벌 강화)

**한인 주의 팁**
- "용돈 받고 계정 빌려드세요" 식 제안은 **형사처벌 대상**이 됩니다. 절대 응하지 마세요.
- 이 법안은 1차 독회 단계이며, 2차 독회(심의·표결) 이후 법률로 확정됩니다.

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "MHA · The Star",
    sources: [
      { name: "MHA — Scams Bill 1차 독회 (공식)", url: "https://www.mha.gov.sg/media-room/newsroom/first-reading-of-the-scams-countermeasures-and-other-matters-bill/" },
      { name: "The Star — New anti-scam laws target Carousell, TikTok (Aug 4)", url: "https://www.thestar.com.my/aseanplus/aseanplus-news/2026/08/04/new-singapore-anti-scam-laws-target-carousell-tiktok-account-mules-online-harms-order-fine-up-from-s1mil-to-s10mil" },
      { name: "Xinhua — Singapore tables anti-scam bill (Aug 5)", url: "https://english.news.cn/20260805/fc2f718b0ccc4c44bf0763f7baf623d1/c.html" },
    ],
    time: "2026년 8월 4일",
    isBreaking: true,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "🦟 뎅기 8주 연속 100건+ — 17개 클러스터, Lentor·Bishan 등 적색경보",
    summary: "8월 1일 종료 주간 뎅기 신규 감염자 119명으로, 8주 연속 주당 100건을 웃돌고 있다. 전국 활성 클러스터는 17개이며, 이 중 6개는 누적 10건 이상의 적색경보 구역이다. 최대 클러스터는 Countryside Road/Lentor Avenue(228건)이며, Lilac Drive/Mimosa Road(45건), Jalan Tari Dulang/Jalan Tari Payong(38건) 순이다. NEA는 5~10월 전통적 뎅기 성수기인 만큼 모기 번식지 제거를 강력히 권고하고 있다.",
    fullContent: `**뎅기 현황 (NEA · The Independent Singapore, 2026년 8월 1일 기준)**
싱가포르가 뎅기 전통 성수기(5~10월) 한복판에 있습니다. 8주 연속 주당 100건을 초과했습니다.

**최신 수치 (8월 1일 종료 주)**
- 주간 신규 감염: **119명** (8주 연속 100건+ 유지)
- 전국 활성 클러스터: **17개**
- 적색경보(누적 10건 이상): **6개 구역**

**주요 클러스터 (적색경보 구역)**
| 구역 | 누적 확진 |
|---|---|
| Countryside Road / Lentor Avenue | **228건** |
| Lilac Drive / Mimosa Road | 45건 |
| Jalan Tari Dulang / Jalan Tari Payong | 38건 |
| Luxus Hill Drive / Seletar Green Avenue | 28건 |
| Ho Ching Road / Yuan Ching Road | 17건 |
| Bishan Street 12 / Bishan Street 13 | 10건 |

**예방·모기 번식지 제거 체크리스트 (NEA 권고)**
- 화분 받침대, 실내 용기, 쓰레기통 — 고인 물 주 2회 이상 비우기
- 에어컨 물받이 확인, 지붕 배수구 막힘 점검
- 뎅기 증상(고열·두통·관절통·발진): 즉시 진료
- 뎅기 클러스터 지도: [NEA Dengue Clusters](https://www.nea.gov.sg/dengue-zika/dengue/dengue-cases)

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "The Independent SG · NEA",
    sources: [
      { name: "The Independent Singapore — Dengue 119 cases, 17 clusters", url: "https://theindependent.sg/dengue-cases-fall-to-119-last-week-but-singapore-still-has-17-active-clusters/" },
      { name: "NEA — Dengue Clusters (실시간)", url: "https://www.nea.gov.sg/dengue-zika/dengue/dengue-cases" },
    ],
    time: "2026년 8월 1일 기준",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "교통",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "🚇 서클라인 17년 만에 완전 루프 완성 — Keppel·Cantonment·Prince Edward Road 3역 개통(7/12)",
    summary: "7월 12일 서클라인(CCL) 6단계 3개 신역(Keppel CC30·Cantonment CC31·Prince Edward Road CC32)이 정식 개통해, 2009년 첫 구간 개통 이후 17년 만에 HarbourFront↔Marina Bay 구간이 연결되며 진정한 순환선이 완성됐다. 전체 33역·39km, 환승역 12곳. 케펠·탄종파가 등 남부 지역과 CBD 접근성이 개선되며, 기존 Bayfront·Marina Bay의 CE1/CE2 코드는 CC34/CC33으로 변경됐다.",
    fullContent: `**서클라인 6단계(CCL6) 개통 (LTA, 2026년 7월 12일)**
싱가포르 지하철 서클라인이 17년 만에 완전한 고리(루프)를 이루었습니다.

**개통 개요**
- **개통일**: 2026년 7월 12일 (공식 서비스 시작). 사전 체험 개방은 7월 4일 9:30am~9:00pm (무료 탑승)
- **3개 신역**: **Keppel(CC30) · Cantonment(CC31) · Prince Edward Road(CC32)**
- **루프 완성**: HarbourFront역↔Marina Bay역 구간 연결 → 서클라인이 진정한 순환선으로 완성 (2009년 첫 개통 후 **17년 만**)

**서클라인 완성 후 사양**
- 총 역 수: **33역**
- 총 연장: 약 **39km**
- 환승역: **12곳** (기존 모든 MRT 노선 연결)
- 피크 배차간격: 약 **2분** (메인 루프), Dhoby Ghaut~Promenade~Bayfront~Marina Bay 구간 약 4분

**주요 지역 접근성**
- **Keppel역**: 케펠만·Keppel Distripark·케펠 크루즈 터미널 인근
- **Cantonment역**: 차이나타운(Chinatown)·탄종파가 인근 접근 편리
- **Prince Edward Road역**: 중심 업무지구(CBD) 남단, 싱가포르 종합병원(SGH) 인근

**기타 변경**
- 기존 Bayfront역(CE1) → **CC34**, Marina Bay역(CE2) → **CC33**으로 노선 코드 변경

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "LTA (공식) · SGTrains",
    sources: [
      { name: "LTA — CCL6 공식 프로젝트 페이지", url: "https://www.lta.gov.sg/content/ltagov/en/upcoming_projects/rail_expansion/circle_line_6.html" },
      { name: "LTA — CCL6 공개 체험 보도자료", url: "https://www.lta.gov.sg/content/ltagov/en/newsroom/2026/5/news-releases/circle-line-stage-6-to-open-for-public-preview-on-4-july-2026.html" },
      { name: "SGTrains — CCL6 개통 상세 기사 (Jul 12)", url: "https://blog.sgtrains.com/2026/07/singapores-circle-line-has-finally-gone-full-circle-three-new-ccl6-stations-open-on-jul-12-2026/" },
    ],
    time: "2026년 7월 12일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "교통",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "🚇 DTL 매주 금요일 심야 단축·토요일 늦은 개통 — 9월 5일까지 (셔틀 S42·S43 운행)",
    summary: "7월 10일부터 9월 5일까지 다운타운라인(DTL) 전 구간이 매주 금요일 밤 11:30pm에 조기 종료되고, 토요일은 8:30am에 늦게 출발한다. TEL 5단계 확장과 동부 통합 차량기지(ECID) 연계 시스템 통합 시험을 위한 조치다. 영향받는 승객을 위해 셔틀버스 S42(부기스↔맥퍼슨, 5~10분 간격)와 S43(부킷판장↔부기스, 5~10분 간격)이 운행된다.",
    fullContent: `**DTL 금요일 심야·토요일 조정 운행 (LTA/SBST/SMRT 공동 발표)**
다운타운라인(DTL) 이용자는 이 기간 금요일 밤·토요일 아침 운행 변동에 주의하세요.

**조정 기간 및 시간**
- **기간**: 2026년 7월 10일(금) ~ 9월 5일(토)
- **매주 금요일 밤**: DTL 전 구간 **11:30pm 조기 종료**
- **매주 토요일 아침**: DTL 전 구간 **8:30am 늦게 개통**

**이유**
- DTL 3단계 연장 구간(Xilin역, DT36) 개통 준비를 위한 **전 노선 시스템 통합 시험** 실시
- 동부 통합 차량기지(East Coast Integrated Depot, ECID) 열차 입출고 작업

**대체 교통 — 셔틀버스**
| 노선 | 구간 | 배차간격 |
|---|---|---|
| **S43** | DTL Bukit Panjang ↔ DTL Bugis | 5~10분 |
| **S42** | DTL Bugis ↔ DTL Macpherson | 5~10분 |
- 부기스(Bugis)역·맥퍼슨(Macpherson)역에서 MRT 다른 노선으로 환승 가능

**한인 팁**
- 금요일 늦게 귀가하거나 토요일 이른 아침 이동 계획이 있는 분은 **앱(MyTransport.SG, 구글맵 등)에서 실시간 운행 시간 미리 확인** 권장
- 영향 없는 대체 경로: EWL(동서선), NSL(남북선), TEL(톰슨-이스트코스트라인)

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "LTA · SBS Transit · SMRT",
    sources: [
      { name: "LTA/SBST/SMRT — DTL 운행 조정 공식 보도자료", url: "https://www.lta.gov.sg/content/ltagov/en/newsroom/2026/4/news-releases/train-service-adjustments-tel-and-dtl-to-facilitate-rail-expansion-works.html" },
      { name: "SGTrains — DTL 조기 종료 상세 기사", url: "https://blog.sgtrains.com/2026/07/downtown-line-to-end-earlier-on-fridays-start-later-on-saturdays-from-jul-10-to-sep-5-2026/" },
      { name: "Land Transport Guru — DTL ECLO Jul-Sep 2026", url: "https://landtransportguru.net/dtl-eclo-jul-sep-2026/" },
    ],
