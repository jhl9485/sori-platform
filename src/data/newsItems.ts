...
const RAW_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    title: "📉 2분기 정리해고 4,500명 — 2020년 4분기 이후 최다, IT·통신 집중·실업률은 2.0% 유지",
    summary: "MTI가 8월 11일 발표한 2분기 경제조사(Economic Survey of Singapore)에 따르면 4~6월 정리해고가 4,500명으로 1분기(3,830명)보다 늘어 2020년 4분기 이후 최다를 기록했다. 주로 정보통신(IT·통신) 업종에서 사업 구조조정이 집중됐다. 반면 실업률(계절조정)은 2.0%로 4분기 연속 유지됐고, 총고용은 10,700명 증가해 19분기 연속 성장세를 이어갔다.",
    fullContent: `**2분기(Q2) 경제조사 발표 (MTI, 8월 11일)**
통상산업부(MTI)가 2026년 2분기 경제조사를 발표했습니다. EP·S Pass로 근무 중인 한인에게 참고가 될 고용 지표입니다.

**정리해고**
- 2분기 정리해고 **4,500명** — 1분기(3,830명)보다 증가, **2020년 4분기 이후 최다**
- 주요 업종: **정보통신(IT·통신)** — 사업 구조조정(business restructuring)이 주원인
- 정리해고 발생률: 1,000명당 **1.9명** (1분기 1.6명에서 상승)

**실업률 & 고용**
- 계절조정 실업률: **2.0%** (4분기 연속 유지)
- 거주자 실업률 2.9%, 시민 실업률 3.0%
- 총고용: **+10,700명** (2021년 4분기 이후 **19분기 연속 증가**)
- 건설·제조업 부문 외국인 채용이 증가를 주도

**한인 참고**
- IT·통신 업종 종사 한인이라면 구조조정 리스크를 유의하고, 이직을 고려한다면 타이밍을 점검할 것
- 전체 고용은 견조하지만 정리해고 규모가 늘어나는 추세 — EP 갱신 시 고용상태 유지가 더 중요해질 수 있음

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "MTI · Human Resources Online",
    sources: [
      { name: "MTI — Release of Second Quarter 2026 Economic Survey of Singapore (공식)", url: "https://www.mti.gov.sg/newsroom/release-of-second-quarter-2026-economic-survey-of-singapore/" },
      { name: "Human Resources Online — Retrenchments in Singapore rose to 4,500 in Q2 2026", url: "https://www.humanresourcesonline.net/retrenchments-in-singapore-rose-to-4-500-in-q2-2026" },
    ],
    time: "2026년 8월 11일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "날씨",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "🌫️ 연무 위험 증가 경보 — NEA, 수마트라·칼리만탄 핫스팟 급증·이번 주 PSI 악화 가능",
    summary: "8월 9일 국경일 당일 싱가포르 중부 지역 24시간 PSI가 81(보통 범위 상단)까지 올랐다. NEA는 같은 날, 건조한 날씨 지속으로 수마트라·칼리만탄 지역 산불 핫스팟이 늘고 있으며 남동쪽 바람을 타고 연무가 싱가포르로 유입될 수 있다고 경보했다. PSI 100 초과(비건강 등급) 시 헤이즈 태스크포스 28개 기관이 즉각 대응 체계를 가동한다.",
    fullContent: `**연무 위험 증가 경보 (NEA, 8월 9일)**
국경일(National Day) 당일 싱가포르 연무 위험이 높아졌습니다.

**현재 상황 (8월 9일 기준)**
- 싱가포르 중부 지역 24시간 PSI **81** — 보통(Moderate) 범위 상단 (PSI 100 초과 시 비건강)
- 수마트라·칼리만탄 지역 **산불 핫스팟 증가**, 연기 기둥 관측
- **남동풍** 기류 시 수마트라 남부 연무가 싱가포르로 유입될 가능성

**NEA 경보 (8월 9일)**
- 건조한 날씨가 계속되면 지역 산불이 심해지고 연무 위험이 더 높아질 수 있다고 경고
- 정부 **헤이즈 태스크포스 28개 기관**은 PSI 100 초과 시 즉각 대응 계획을 가동할 준비 완료

**⚠️ 한인 행동 요령**
- 외출 전 **haze.gov.sg** 또는 NEA **myENV** 앱에서 1시간·24시간 PSI 확인
- PSI 100 초과 시 야외 활동(특히 격렬한 운동)을 줄이고 N95 마스크 착용
- 호흡기 질환자·어린이·노약자가 있는 가정은 공기청정기 미리 가동
- 연무 피해는 특히 **8~9월이 피크 시즌** — SIIA 레드 경보 수준 유지 중

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "NEA · Mothership",
    sources: [
      ...
      { name: "The Star — Risk of haze in Singapore if dry conditions, regional hot spots continue", url: "https://www.thestar.com.my/aseanplus/aseanplus-news/2026/08/09/risk-of-haze-in-singapore-if-dry-conditions-regional-hot-spots-continue-in-the-coming-week" },
    ],
    time: "2026년 8월 9일",
    isBreaking: true,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "🇸🇬 PM 웡 국경일 메시지 — AI 일자리·가족 지원 전면 검토, 8월 23일 Rally에서 구체 정책 발표",
    summary: "로런스 웡 총리가 8월 8일 방송된 국경일 메시지에서 AI 기술이 사람 편에서 더 나은 일자리를 창출해야 한다고 강조했다. 또 결혼·육아에 그치지 않고 자녀 양육비·보육 접근성 등 생애 전반의 가족 지원 체계를 전면 재검토 중이라고 밝혔다. 미국·이스라엘·이란 갈등으로 대외 불확실성이 높다고 경고하며, 8월 23일 ITE 컬리지 센트럴에서 열리는 국경일 랠리(National Day Rally)에서 구체적인 정책을 발표할 예정이라고 예고했다.",
    fullContent: `**로런스 웡 총리 국경일 메시지 (2026년 8월 8일 방송)**
8월 9일 건국 61주년 국경일을 앞두고 총리가 국민에게 전한 메시지입니다.

**주요 내용**

**AI와 일자리**
- "AI는 더 나은 일자리를 만드는 방향으로 활용돼야 한다"고 강조
- AI가 생산성을 높이고 근로자 성장을 돕는 방식으로 기업이 도입해야 한다는 기대 표명

**가족 지원 전면 검토**
- 결혼·육아 단계에 집중됐던 기존 정책을 넘어 **생애 전반의 가족 지원 체계**를 재검토 중
- 자녀 양육 비용, 영아·육아 시설 접근성 개선 등이 핵심 검토 사항
- 구체적 개편안은 8월 23일 랠리에서 발표 예정

**대외 불확실성 경고**
- 미국·이스라엘·이란 갈등, 무역장벽 증가, 국가 간 신뢰 약화 등 글로벌 리스크 언급
- 싱가포르는 이런 환경에서 단합과 회복력으로 대응해야 한다고 강조

**국경일 랠리 예고**
- **8월 23일(일)** ITE 컬리지 센트럴에서 국경일 랠리(National Day Rally) 개최
- 더 구체적인 정책 발표가 이어질 예정

**한인 참고**
- 보육 지원·직장 내 AI 활용 등 정책 변화는 싱가포르 거주 한인에게도 직접 영향을 줄 수 있어, 8월 23일 Rally 발표에 주목할 것

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "Malay Mail · PMO",
    sources: [
      { name: "Malay Mail — In Singapore National Day message, Lawrence Wong promises support plan for families amid global uncertainty", url: "https://www.malaymail.com/news/singapore/2026/08/09/in-singapore-n-day-message-lawrence-wong-promises-support-plan-for-families-amid-global-uncertainty/230660" },
      { name: "PMO — National Day Message 2026 (공식)", url: "https://www.pmo.gov.sg/newsroom/national-day-message-2026/" },
    ],
    time: "2026년 8월 8일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "사회",
    catStyle: "bg-[#F5F0FF] text-[#7040C0]",
    title: "☕ 'Fun Coffee' 투자 앱 폰지 사기 — SPF 49세 여성 검거, 홍콩서만 225건·S$1,700만 피해",
    summary: "싱가포르 경찰(SPF)이 8월 8일 베트남 기반 투자 앱 'Fun Coffee' 관련 수사에서 49세 여성을 체포했다. 사기범들은 앱에 달러 연동 암호화폐 USDT를 입금하면 고수익과 신규 회원 유치 수당을 제공한다고 홍보했다. 피해자들은 출금이 막히고 나서야 사기임을 알아챘다. 8월 5일 기준 홍콩 경찰에만 225건 신고·약 HK$1억400만(약 S$1,700만) 피해가 접수됐으며 싱가포르 수사는 계속 중이다.",
    fullContent: `**'Fun Coffee' 투자 앱 폰지 사기 경보 (SPF, 2026년 8월 8일)**
싱가포르 경찰(SPF)이 8월 8일 투자 사기 혐의로 49세 여성을 체포했다고 발표했습니다.

**수법**
- 베트남 기반 'Fun Coffee' 앱 설치를 유도 → 달러 연동 암호화폐 **USDT**를 제공된 지갑 주소로 입금하게 함
- 비현실적인 고수익을 약속하고, 타인 모집 시 추가 수당 제공(다단계 구조)
- 투자 후 출금 시도 시 인출 불가 → 그제서야 사기임을 인지

**피해 규모 (8월 5일 기준)**
- **홍콩 경찰**: 225건 신고, 피해액 약 **HK$1억400만(약 S$1,700만)**
- 싱가포르 피해 규모는 수사 진행 중

**체포**
- SPF는 8월 6일 Fun Coffee 관련 수사를 발표하고, 8월 8일 이를 적극 홍보한 49세 여성을 체포

**⚠️ 한인 주의 팁**
- SNS·메신저에서 '고수익 보장' 앱 투자를 홍보하는 사람은 신뢰하지 말 것
- USDT·비트코인 등 암호화폐 송금 요구는 사기를 강하게 의심할 것 — 한번 송금하면 되찾기 매우 어렵다
- 해당 앱에 이미 투자했다면 SPF에 신고(1800-255-0000)하거나 온라인(police.gov.sg/i-witness) 신고
- 의심 시 ScamShield 앱 또는 핫라인 **1799** 확인

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "SPF · Malay Mail",
    sources: [
      { name: "SPF — Investigation Into The 'Fun Coffee' Platform (공식)", url: "https://www.police.gov.sg/Media-Hub/News/2026/08/20260808_investigation_into_the_fun_coffee_platform" },
      { name: "Malay Mail — Singapore woman arrested as alleged Fun Coffee Ponzi scheme leaves victims millions out of pocket", url: "https://www.malaymail.com/news/singapore/2026/08/08/singapore-woman-arrested-as-alleged-fun-coffee-ponzi-scheme-leaves-victims-millions-out-of-pocket/230586" },
    ],
    time: "2026년 8월 8일",
    isBreaking: true,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "건강",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "🦟 뎅기열 주간 119건·17개 클러스터 — 렌터 애비뉴(228건)·잘란 타리 두 곳 빠르게 확산",
    summary: "8월 1일까지 집계된 주간 뎅기열 신규 감염자가 119명으로 올해 최고치를 기록했고, 8주 연속 주간 100건을 초과했다. 싱가포르 전역 17개 활성 클러스터 중 6곳은 누적 10건 이상의 블랙스팟이다. 컨트리사이드 로드/렌터 애비뉴(228건)·잘란 타리 두랑/잘란 타리 파용(38건) 클러스터가 빠르게 퍼지고 있다. 2026년 누적 감염자는 1,700명을 넘어섰다.",
    fullContent: `**뎅기열 현황 (NEA 집계, 8월 1일 기준 주간)**
뎅기 피크 시즌(5~10월)이 한창인 가운데 감염이 급증하고 있습니다.

**최근 통계**
- 주간 신규 감염자: **119명** (8월 1일까지 집계) — 2026년 최고치, **8주 연속** 주간 100건 초과
- 2026년 누적 감염자: **1,700명 이상**
- 활성 클러스터: **17개**, 이 중 누적 10건 이상 **블랙스팟 6개**

**주요 클러스터 (빠르게 확산 중)**
- **컨트리사이드 로드/렌터 애비뉴**: 누적 **228건** (싱가포르 북부)
- **잘란 타리 두랑/잘란 타리 파용**: 누적 **38건**
- 모기 번식지로 실내 화분 받침대·플라스틱 용기·쓰레기통이 확인됨

**⚠️ 한인 가정 예방 수칙**
- 집 안팎의 고인 물을 주 1회 이상 제거(꽃병·화분 받침·에어컨 트레이 포함)
- 야외 활동 시 모기 기피제 사용(낮 활동 모기인 이집트숲모기 주의)
- 발열·두통·근육통·발진이 동반되면 즉시 의원·병원 방문
- 집 근처 클러스터 여부는 NEA **myENV** 앱 또는 nea.gov.sg에서 확인
