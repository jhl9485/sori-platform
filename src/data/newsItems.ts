...
const RAW_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    title: "🚔 신설 사이버커맨드 첫 작전 — 255명 수사, 660건·약 S$560만 피해",
    summary: "SPF가 7월 3일 발족한 신설 사이버커맨드(Cyber Command)와 7개 경찰 관할구역이 7월 16~29일 합동 작전을 벌인 결과를 7월 30일 발표했다. 255명(남 172·여 83, 16~77세)이 수사 대상이며 전자상거래·피싱·취업·정부기관사칭·투자·행운권 사기 660건 이상, 피해액 약 S$560만과 연루됐다. 사기죄는 최대 10년 징역, 자금세탁은 최대 10년 징역+S$50만 벌금이다.",
    fullContent: `**SPF 사이버커맨드 첫 대규모 작전 결과 (2026년 7월 30일 발표)**
싱가포르 경찰청(SPF)이 7월 3일 신설한 온라인 사기·사이버범죄 전담 부서 사이버커맨드(Cyber Command)의 첫 대규모 작전 결과입니다.

**수사 개요**
- **작전 기간**: 2026년 7월 16~29일
- **합동 주체**: 사이버커맨드 + 7개 경찰 관할구역
- **수사 대상**: **255명** (남 172명·여 83명, 16~77세)
- **연루 사건**: **660건 이상** — 전자상거래·피싱·취업·정부기관사칭·투자·행운권 사기
- **피해액**: 약 **S$560만(S$5.6 million)**

**처벌 기준**
- 사기죄(Cheating): 최대 **10년 징역 + 벌금**
- 자금세탁(Money Laundering): 최대 **10년 징역 + S$50만 벌금**
- 무허가 결제서비스 운영: 최대 **3년 징역 + S$12만5천 벌금**

**한인 주의 팁**
- 본인 계좌·명의를 타인에게 빌려주면 머니뮬로 처벌받을 수 있습니다.
- 의심스러운 취업 제안·투자 권유·정부기관 사칭 전화는 즉시 끊고 ScamShield 앱 또는 핫라인 1799에 신고하세요.

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "SPF · The Star",
    sources: [
      { name: "The Star — Singapore police probe 255 over scam cases involving losses of about $5.6 million (July 30, 2026)", url: "https://www.thestar.com.my/aseanplus/2026/07/30/singapore-police-probe-255-over-scam-cases-involving-losses-of-about-56-million" },
      { name: "SPF — PM Lawrence Wong Visits the SPF's Cyber Command (공식)", url: "https://www.police.gov.sg/Media-Hub/Police-Life/2026/07/Inside-Singapores-Scam-War-PM-Lawrence-Wong-Visits-the-SPFs-Cyber-Command" },
    ],
    time: "2026년 7월 30일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "📦 닌자반·J&T Express 사칭 택배 피싱 주의 — '+212 모로코 번호' 문자, S$25.9만 피해",
    summary: "SPF가 7월 15일 택배사 사칭 피싱 경보를 발령했다. 6월 24일 이후 43건·피해액 S$25만9천 이상. 모로코 국가코드(+212) 또는 무작위 이메일 주소에서 닌자반(Ninja Van)·J&T Express를 사칭, '주소 오류로 배송 실패' 문자와 함께 가짜 사이트 링크를 보낸다. 소액 재배송료(6센트~S$1.64) 명목으로 카드 정보를 탈취한 뒤 피해자 몰래 카드를 Google Pay·Apple Pay에 무단 등록한다.",
    fullContent: `**택배회사 사칭 피싱 사기 경보 (SPF, 2026년 7월 15일)**
싱가포르 경찰(SPF)이 닌자반(Ninja Van)·J&T Express를 사칭한 피싱 사기가 급증하고 있다고 경보를 발령했습니다.

**피해 현황**
- **2026년 6월 24일 이후** 최소 **43건**, 피해액 **S$25만9천(S$259,000) 이상**
- 7월 13일 하루에만 **20건** 신고 접수

**수법 단계별 설명**
1. 모로코 국가코드(**+212**)로 시작하는 번호 또는 무작위 이메일 주소에서 닌자반·J&T Express 명의로 문자·이메일 발송
2. "배송 주소 오류 — **24시간 이내** 주소를 업데이트하세요"라는 링크 포함
3. 클릭하면 실제 택배사 사이트와 유사한 **가짜 사이트**로 이동
4. **재배송료 6센트~S$1.64** 결제를 위해 카드 정보 입력 유도
5. 이후 피해자 몰래 카드를 **Google Pay / Apple Pay에 무단 등록** → 추가 결제 발생

**한인 주의 팁**
- +212(모로코) 등 예상치 못한 국가코드에서 오는 '배송 관련' 문자 링크는 클릭 금지
- 소액이라도 카드 정보 입력 후 의심스러우면 즉시 카드사에 연락해 결제 정지 요청
- 실제 배송 조회는 택배사 공식 앱·사이트에서 직접 접속
- 신고: ScamShield 앱 또는 SPF 1800-255-0000

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "SPF (공식)",
    sources: [
      { name: "SPF — Police Advisory On Phishing Scams Impersonating Courier Companies (2026년 7월 15일, 공식)", url: "https://www.police.gov.sg/Media-Hub/News/2026/07/20260715_police_advisory_on_phishing_scams_impersonating_courier_companies" },
      ...
      { name: "Nestia — Victims lose more than S$259,000 in courier phishing scams since Jun 24", url: "https://news.nestia.com/detail/Victims-lose-more-than-S$259,000-in-courier-phishing-scams-since-Jun-24/14123316" },
    ],
    time: "2026년 7월 15일",
    isBreaking: false,
    readTime: "2분",
    emoji: "📦",
    relatedIds: ["auto-20260716-1", "auto-20260730-1"],
  },
  {
    id: "auto-20260730-3",
    ...
    title: "💼 S Pass 쿼터 기준 'LQS' 7/1부터 S$1,800으로 인상 — 일부 기업 외국인 채용 한도 변동 가능",
    summary: "MOM의 '로컬 적정급여(LQS, Local Qualifying Salary)'가 7월 1일부터 S$1,600에서 S$1,800으로 올랐다. LQS는 S Pass·워크퍼밋(WP) 외국인 채용 쿼터 계산 시 로컬 직원 '1명분'으로 인정되는 최저 월급 기준이다. S$1,600~S$1,799 구간 로컬 직원은 이전엔 1.0명분이었지만 이제 0.5명분으로 낮아져 일부 기업의 S Pass 채용 한도가 줄어들 수 있다. 시간제 기준도 시간당 S$9→S$10.50으로 올랐다.",
    fullContent: `**로컬 적정급여(LQS) S$1,800 인상 (2026년 7월 1일 시행)**
MOM이 7월 1일부터 외국인 채용 쿼터 산정에 쓰이는 로컬 적정급여(LQS)를 인상했습니다.

**LQS(Local Qualifying Salary)란?**
S Pass·워크퍼밋(WP) 외국인을 채용하려면 회사가 일정 비율의 로컬(시민·PR) 직원을 유지해야 합니다(쿼터제). 이 쿼터 계산 시 로컬 직원이 **'1명분'으로 인정받으려면** 월급이 LQS 이상이어야 합니다.

**변경 내용 (2026년 7월 1일 시행)**
- **전일제 LQS**: S$1,600 → **S$1,800** (월급 기준)
- **파트타임 LQS**: 시간당 S$9 → **S$10.50**
- S$1,600~S$1,799 구간 로컬 직원: 기존 1.0명분 → **0.5명분**으로 하락

**기업 영향**
- 이 구간 로컬 직원이 많은 회사는 카운트가 줄어 **S Pass 채용 한도가 감소**할 수 있음
- 정부는 보완 차원에서 **프로그레시브 웨이지 크레딧 스킴(PWCS) 정부 공동부담을 20%→30%**로 상향(2026년 한시 적용)

**한인 고용주·HR 담당자 참고**
- 7월 이후 S Pass 신규 채용 전 쿼터 재계산 필요
- 해당 구간 로컬 직원 월급을 S$1,800 이상으로 조정하면 쿼터 영향 없음
- 자세한 계산은 MOM MyMOM Portal에서 확인 가능

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "MOM · Singapore Employment Agency",
    sources: [
      ...
      { name: "kmerleone.com — Singapore Raises the Local Qualifying Salary (LQS) to $1,800 from 1 July 2026", url: "https://www.kmerleone.com/post/singapore-raises-the-local-qualifying-salary-lqs-to-1-800-from-1-july-2026" },
      { name: "Migrant Times — Singapore Raises Local Qualifying Salary to S$1,800", url: "https://migrantimes.com/labour-policy/02-07-2026/singapore-raises-local-qualifying-salary-to-s1800" },
    ],
    time: "2026년 7월 1일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "교통",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "🚇 MRT '2011년 집계 이래 최장 무지연 기록' — 다운타운선 금요 밤 11:30 조기 종료(~9/5)",
    summary: "LTA 발표에 따르면 2025년 11월 이후 30분 이상 MRT 지연이 단 한 건도 발생하지 않아 2011년 통계 집계 이후 최장 기간을 기록 중이다. 6월 기준 운행률·정시율은 99% 이상. 다만 다운타운선(DTL) 전 구간은 7월 10일~9월 5일 매주 금요일 밤 11시 30분에 조기 종료되고 토요일 오전 8시 30분에 늦게 시작하니 DTL 이용자는 심야 이동 계획에 주의가 필요하다.",
    fullContent: `**MRT 최장 무지연 기록 및 다운타운선 심야 서비스 변경 (2026년 7월)**

**MRT 신뢰도 최장 기록**
LTA가 공개한 지표에 따르면, 2025년 11월 이후 MRT 전 노선에서 **30분 이상 지연이 단 한 건도 발생하지 않았습니다**. 이는 LTA가 2011년부터 이 통계를 집계한 이후 **가장 긴 연속 무(無)지연 기간**입니다.
- 2026년 6월 기준 **열차 서비스 이행률·정시율: 99% 이상** 유지

**⚠️ 다운타운선(DTL) 심야 서비스 변경 — 현재 진행 중 (7월 10일~9월 5일)**
- **매주 금요일 밤**: 평소 자정(0:00)이 아닌 **밤 11시 30분(23:30) 조기 종료**
- **매주 토요일 아침**: 평소 오전 5시 30분이 아닌 **오전 8시 30분 늦게 운행 시작**
- 적용 구간: DTL 전 구간(부기스~엑스포 방향 포함)
- 적용 기간: **2026년 7월 10일 ~ 9월 5일** (현재 진행 중)

**한인 참고 팁**
- 금·토 심야에 다운타운선(차이나타운·부기스·부킷 팡앙·엑스포 방면 등)을 이용할 계획이라면 버스 대체 또는 Grab·택시를 미리 준비하세요.
- 야간 운행 단축은 선로·신호 정비를 위한 엔지니어링 작업으로, 9월 5일 이후 정상화됩니다.

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "Mothership · LTA",
    sources: [
      { name: "Mothership — No MRT delays above 30 min since Nov. 2025, longest such period since records started in 2011", url: "https://mothership.sg/2026/07/mrt-rail-reliability-figures/" },
      { name: "Land Transport Guru — Singapore MRT Map (July 2026)", url: "https://landtransportguru.net/singapore-mrt-map-jul2026/" },
    ],
    time: "2026년 7월",
    isBreaking: false,
    readTime: "2분",
