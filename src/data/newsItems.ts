...
const RAW_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    title: "🌫️ 연무 주의보 — 8/9 PSI 81 '보통' 상한, SIIA 8~9월 최대 위험 기간 경고",
    summary: "8월 9일 오후 1시 기준 싱가포르 중부 24시간 PSI가 81을 기록해 '보통(Moderate)' 범위 상한에 근접했다. 싱가포르국제문제연구소(SIIA)는 올해 6월 8~9월을 최대 위험 기간으로 지목하며 드문 '레드' 경보를 발령했다. 수마트라·칼리만탄 화재 열점과 남동풍이 연무를 싱가포르 방향으로 이동시킬 수 있어 NEA가 경보를 내렸다. 정부 28개 기관으로 구성된 연무 태스크포스는 PSI 100 초과 시 즉시 가동할 준비를 갖추고 있다.",
    fullContent: `**연무(Haze) 주의보 — 2026년 8월**

**현황 (8월 9일 기준)**
- 싱가포르 중부 24시간 PSI: **81** (오후 1시) — '보통(Moderate)' 범위 상한 근처
- PSI **101 이상**이 '건강에 해로운(Unhealthy)' 기준

**배경**
- 싱가포르국제문제연구소(SIIA)가 2026년 6월 싱가포르·말레이시아·인도네시아·브루나이 대상 **드문 '레드' 경보**를 발령, **8~9월이 최대 위험 기간**임을 경고
- 수마트라·칼리만탄에서 화재 열점(hotspot)과 연기가 관측됨
- 남동풍이 연무를 싱가포르 방향으로 이동시킬 수 있는 조건
- 엘니뇨 강화·ASEAN 남부 강수량 부족 예보가 건조 상황을 악화시킬 수 있음

**정부 대응**
- **28개 정부 기관**으로 구성된 연무 태스크포스, PSI 100 초과 시 즉시 가동 준비
- NEA가 열점 상황과 PSI를 지속 모니터링 중

**한인 건강 팁**
- PSI 101~200 ('건강에 해로움'): 노약자·어린이·호흡기 질환자 야외 활동 자제, 건강한 성인도 격렬한 운동 피할 것
- PSI 200 이상: 외출 시 N95 마스크 착용 권고
- 실시간 PSI: NEA 공식 앱 또는 haze.gov.sg에서 확인

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "Mothership · The Star · SIIA",
    sources: [
      { name: "Mothership — NEA 연무 경보 (8월)", url: "https://mothership.sg/2026/08/haze-risk-increase-nea/" },
      { name: "The Star — 싱가포르 연무 위험 (8/9)", url: "https://www.thestar.com.my/aseanplus/aseanplus-news/2026/08/09/risk-of-haze-in-singapore-if-dry-conditions-regional-hot-spots-continue-in-the-coming-week" },
    ],
    time: "2026년 8월 9일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "교통",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "🚌 8/29부터 AXS 기기에서 EZ-Link 충전 종료 — 대체 방법 미리 확인",
    summary: "2026년 8월 29일부터 전국 AXS 기기에서 EZ-Link 및 SimplyGo EZ-Link 카드 충전이 불가능해진다. SimplyGo 공식 사이트에 해당 변경 사항이 명시됐다. AXS로 교통카드를 충전해온 한인은 편의점·MRT역 발권기(GTM)·EZ-Link 앱 등 다른 방법으로 미리 전환해야 한다.",
    fullContent: `**EZ-Link / SimplyGo EZ-Link 카드 AXS 충전 종료 (8월 29일)**

**핵심 변경**
- **2026년 8월 29일(토)부터** AXS 기기에서 EZ-Link 카드 및 SimplyGo EZ-Link 카드 충전 서비스 종료
- SimplyGo 공식 홈페이지에 해당 공지가 게시됨

**대체 충전 방법 (⚠️ 미검증 — SimplyGo 공식 사이트에서 최종 확인 바람)**
- MRT역·버스환승역 내 **GTM(General Ticketing Machine)** 발권기
- **7-Eleven, Cheers, NTUC FairPrice** 등 편의점
- **EZ-Link 앱** (스마트폰 NFC 충전)
- 기타 SimplyGo 지정 채널

**한인 참고**
- AXS로만 충전해온 분은 8월 29일 이전에 다른 방법을 미리 파악해두세요.
- 정확한 대체 충전처 전체 목록은 SimplyGo 공식 사이트에서 확인하세요.

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "SimplyGo (공식)",
    sources: [
      { name: "SimplyGo 공식 — EZ-Link 관련 공지", url: "https://simplygo.com.sg/" },
      { name: "SimplyGo — EZ-Link FAQs", url: "https://simplygo.com.sg/faqs/cards-and-charms/cepas/ez-link-cards-and-charms/" },
    ],
    time: "2026년 8월",
    isBreaking: false,
    readTime: "1분",
  ...
  },
  {
    ...
    category: "취업",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "📉 Q3 싱가포르 고용 전망 4년 최저 +13% — Shopee 개발자 8% 감원·금융 섹터 NEO 마이너스",
    summary: "ManpowerGroup 3분기 고용전망조사(MEOS)에서 싱가포르 계절조정 순고용전망(NEO)이 +13%로 2021년 4분기 이후 최저를 기록했다(전분기·전년 대비 각각 -11%p). 금융·보험 섹터만 NEO -2%로 주요 업종 중 유일하게 마이너스다. Shopee(Sea Limited)는 AI 전환을 이유로 전 세계 개발자 8%를 감원(싱가포르 포함, 최종 퇴직일 8월 말)했다. Q2 2026 전체 실업률은 2.1%로 위기 수준은 아니다.",
    fullContent: `**싱가포르 취업 시장 동향 (2026년 Q3 기준)**

**ManpowerGroup Q3 2026 MEOS (싱가포르)**
- 계절조정 순고용전망(NEO): **+13%** — **2021년 4분기 이후 최저**
- 전분기·전년 대비 각각 **-11%p** 하락
- 아시아태평양·중동 지역 평균(+28%)과 전 세계 평균(+26%)을 크게 하회

**업종별 전망 (싱가포르 Q3)**
- **금융·보험: NEO -2%** (주요 업종 중 유일하게 마이너스 — 감원 계획이 채용보다 많음)
- 제조업: +25% (가장 강세), 건설·부동산: +20%

**Shopee 글로벌 감원**
- Shopee(모기업 Sea Limited)가 AI 전환 가속화를 이유로 **전 세계 개발자 직군의 약 8%** 감원
- 2026년 6월 8일 시작, 싱가포르 내 제품·엔지니어링 팀 포함, **최종 퇴직일 8월 말**
- 싱가포르 Taskforce for Responsible Retrenchment은 해당 감원을 통보받았으며, Sea는 삼자 지침에 따른 퇴직금을 지급하기로 했음

**고용 지표 (Q2 2026)**
- 전체 실업률: **2.1%** / 거주자: 2.9% / 시민: 3.1% — 위기 수준 아님

**한인 참고**
- IT·금융 직종 이직 검토 시 현재 시장 흐름을 감안해 충분히 준비할 것
- EP 유지·갱신에는 고용주의 COMPASS 현지채용 비율도 영향 — 채용 보수화가 갱신 리스크로 연결될 수 있음

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "ManpowerGroup · People Matters",
    sources: [
      { name: "ManpowerGroup — Q3 2026 MEOS 글로벌 보고서", url: "https://www.manpowergroup.com.sg/meos" },
      { name: "People Matters — 싱가포르 금융 섹터 고용 전망", url: "https://sea.peoplemattersglobal.com/news/strategic-hr/singapore-finance-sector-set-for-job-cuts-as-employers-turn-cautious-survey-50170" },
      { name: "People Matters — Shopee 글로벌 감원", url: "https://sea.peoplemattersglobal.com/news/workforce-planning/shopee-cuts-jobs-in-singapore-as-ai-expansion-gathers-pace-50272" },
    ],
    time: "2026년 Q3",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "🏘️ HDB 재판매 가격 2분기 연속 하락 — Q2 2026 0.3%↓, 렌트는 연 1~3% 소폭 상승 전망",
    summary: "Q2 2026 HDB 재판매가격지수(RPI)가 202.8로 전분기 대비 0.3% 하락해 2분기 연속 하락했다(1분기 -0.1%). 2019년 이후 처음 있는 2연속 하락이다. 하지만 거래는 안정적이며, 임대 승인 건수는 전분기 대비 4.9% 증가한 10,002건을 기록했다. 중앙·퀸즈타운·토아파요 지역 4룸 재판매 중앙값은 100만 달러를 넘겼다. 2026년 HDB 렌트는 연 1~3% 소폭 상승이 전망된다.",
    fullContent: `**HDB 재판매 시장 Q2 2026 (HDB 공식 데이터)**
공공 아파트 재판매 또는 임대를 고려 중인 한인에게 유용한 정보입니다.

**재판매 가격 지수**
- Q2 2026 HDB Resale Price Index: **202.8** — 전분기 대비 **-0.3%** (2분기 연속 하락)
- 1분기(-0.1%)에 이어 2분기 연속 마이너스 — **2019년 이후 처음**
- 전년 동기 대비로는 약 +1.19% YoY — 장기 상승 흐름은 유지

**지역별 주목**
- 중앙(Central)·퀸즈타운·토아파요 **4룸 재판매 중앙값 S$100만 이상** — 밀리언달러 플랫 사례 지속

**임대 시장**
- Q2 승인 임대 신청: **10,002건** (Q1 9,535건 → +4.9% 증가)
- 전체 임대 재고: 58,855개 (Q1 58,698개에서 소폭 증가)
- 2026년 HDB 렌트 전망: 연간 **+1~3%** 소폭 상승

**한인 참고**
- 재판매가 하락 추세이나 거래량은 안정 — 렌트 수요는 여전히 견조
- 렌트 재계약 시 집주인이 가격을 크게 낮추기 어려울 수 있음 (수요 탄탄)
- 개별 단지·위치에 따라 차이가 크니 계약 전 실거래가 조회 권고

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "99.co · EdgeProp · ERA",
    sources: [
      { name: "99.co — Q2 2026 HDB 재판매가 하락", url: "https://www.99.co/singapore/insider/hdb-resale-prices-fell-in-q2-2026-as-market-continues-to-stabilise/" },
      { name: "EdgeProp — Q2 2026 HDB 2연속 하락", url: "https://www.edgeprop.sg/property-news/hdb-resale-prices-fall-second-consecutive-quarter-down-03-2q2026" },
      { name: "ERA — Q2 2026 HDB 분기 보고서", url: "https://www.era.com.sg/research-articles/2q-2026-hdb-quarterly-report" },
    ],
    time: "2026년 Q2 (7월 발표)",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "💼 EP 갱신도 COMPASS 의무화 — 7/1부터 전면 시행, 최저급여 S$5,600·최소 40점",
    summary: "2026년 7월 1일부터 싱가포르 고용패스(EP) 갱신에도 COMPASS(보완성 평가 프레임워크)가 의무 적용된다. 비금융 직군 최저 고정급여 S$5,600, 금융 직군 S$6,200을 충족해야 하며, COMPASS 기본·보너스 기준 합산 최소 40점 이상이어야 갱신이 가능하다. 부족직업군(C5) 목록이 개편돼 일부 IT 직종이 삭제되고 헬스케어가 추가됐다. 2년 전 기준으로 통과했어도 기업의 현지채용 비율이 낮아지거나 급여가 최신 기준에 못 미치면 갱신이 거부될 수 있다.",
    fullContent: `**EP COMPASS 갱신 의무화 (2026년 7월 1일 전면 시행)**
싱가포르 EP를 보유한 한인이라면 갱신 시점에 반드시 확인해야 할 사항입니다.

**무엇이 바뀌었나**
- 2026년 **1월 1일**: 새 급여 기준이 신규 EP 신청에 적용
- 2026년 **7월 1일**: 만료일이 7월 1일 이후인 **모든 EP 갱신**에 COMPASS 의무 적용 (신규·갱신 구분 없이 전면 시행)

**최저 고정급여 기준**
- 비금융 직군: 월 **S$5,600** 이상
- 금융 서비스 직군: 월 **S$6,200** 이상
- (연령대가 높을수록 기준 급여가 높아짐 — 40대 중반 기준 약 S$10,700~S$11,800)

**COMPASS 채점 구조**
- 기본 기준 4가지(C1 급여·C2 자격·C3 다양성·C4 지원 프로그램) + 보너스 2가지(C5 부족직업군·C6 전략적 우선)
- **총 40점 이상**이어야 갱신 통과

**C5 부족직업군 변경 (2026년 1월 기준)**
- **헬스케어 직종 추가**, 일부 **IT·테크 직종 제거**

**주의: 과거 통과해도 이번에 탈락할 수 있음**
- 기업의 현지 PMET 채용 비율이 떨어졌거나 급여가 최신 기준에 미달하면 갱신 거부 가능
- 고용주가 먼저 COMPASS 상태를 점검해야 함

**한인 체크리스트**
1. EP 만료일 확인 → 7월 1일 이후 만료라면 COMPASS 기준으로 갱신 필요
2. 내 고정급여가 직군별 최저 기준을 충족하는지 확인
3. MOM 셀프체크 툴로 COMPASS 점수 예상 확인
4. 부족직업군 여부: MOM 공식 SOL 목록 확인

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "Human Resources Online · KPMG · Singapore Secretary Services",
    sources: [
      { name: "Human Resources Online — COMPASS 2026 갱신 안내", url: "https://www.humanresourcesonline.net/reminder-singapore-s-updated-compass-rules-effective-in-2026-for-ep-applications-and-renewals" },
      { name: "KPMG — 2026 워크패스 업데이트 (2025년 12월)", url: "https://kpmg.com/xx/en/our-insights/gms-flash-alert/flash-alert-2025-282.html" },
      { name: "Singapore Secretary Services — EP COMPASS 갱신 7/1 가이드", url: "https://www.singaporesecretaryservices.com/ep-compass-renewal-from-1-july-2026-what-every-singapore-employer-must-do/" },
    ],
    time: "2026년 7월 1일 시행",
    isBreaking: false,
    readTime: "3분",
