...
const RAW_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    title: "🚔 전국 사기 단속 270명 조사 — 2주간(7/30~8/12) 660건·S$540만 피해, 8/16 별도로 20명 기소",
    summary: "싱가포르 경찰청(SPF)이 7월30일~8월12일 2주간 사이버커맨드·7개 경찰구역 합동으로 사기·머니뮬 혐의자 270명(남185·여85, 15~80세)을 조사했다고 8월13일 발표했다. 전자상거래·피싱·취업·정부기관사칭·투자·행운의추첨 사기 등 660건 이상(피해 약 S$540만)과 연관됐다. 별도로 8월16일에는 사기 관련 머니뮬 혐의 20명이 법원에 기소됐다.",
    fullContent: `**전국 사기 단속 결과 (SPF, 2026년 8월 13일 발표)**
SPF 사이버커맨드와 7개 경찰구역이 2주간 벌인 합동 단속 결과입니다.

**단속 개요**
- **기간**: 7월 30일~8월 12일 (2주)
- **조사 인원**: **270명** (남 185·여 85, 15~80세)
- **연관 사건**: **660건 이상** / 피해액 약 **S$540만**
- **사기 유형**: 전자상거래·피싱·취업·정부기관사칭·투자·행운의추첨 사기

**추가 기소 (8월 16일)**
- 별도 수사로 머니뮬(계좌·명의 대여) 혐의 **20명**이 법원에 기소됐다

**처벌**
- 사기(Section 420 Penal Code): 최대 **징역 10년 + 벌금**
- 머니뮬: 최대 **태형 12대 + 은행·통신 서비스 제한**

**⚠️ 한인 주의 팁**
- '쉽게 돈 버는 알바'로 본인 계좌를 빌려주면 머니뮬 공범이 될 수 있음 — 절대 응하지 말 것
- 의심 시 ScamShield 앱 또는 안티스캠 핫라인 **1799** 확인

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "SPF (공식)",
    sources: [
      { name: "SPF — 270명 단속 발표 (공식)", url: "https://www.police.gov.sg/Media-Hub/News/2026/08/20260813_police_investigate_270_scammers_and_money_mules_in_islandwide_enforcement_operation" },
      { name: "SPF — 20명 기소 (공식)", url: "https://www.police.gov.sg/Media-Hub/News/2026/08/20260816_twenty_persons_to_be_charged_for_suspected_involvement_in_scam" },
    ],
    time: "2026년 8월 13일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "🦟 뎅기열 성수기 — 17개 활성 클러스터, 8주 연속 주간 100건 이상·Lentor Ave 228건 최다",
    summary: "8월1일 기준 2026년 누적 뎅기열 1,700건 이상, 17개 활성 클러스터(이 중 6곳 블랙스팟). 가장 큰 클러스터는 Countryside Road/Lentor Avenue(228건). 5~10월 성수기가 계속되는 가운데 NEA가 화분 받침대·에어컨 응결수 등 실내 모기 번식지 점검을 촉구하고 있다.",
    fullContent: `**뎅기열 경보 (2026년 8월)**
싱가포르는 매년 5~10월이 뎅기열 성수기입니다. 2026년은 특히 주의가 필요합니다.

**현황 (8월 1일 주 기준)**
- 2026년 누적 환자 **1,700건 이상** — 8주 연속 주간 100건 이상
- **17개 활성 클러스터** (그 중 **6곳 블랙스팟**: 누적 10건 이상)
- 최다 클러스터: **Countryside Road/Lentor Avenue** (228건)
- 주요 클러스터: Jalan Tari Dulang/Jalan Tari Payong(38건), Lilac Drive/Mimosa Road(45건), Luxus Hill Drive/Seletar Green Avenue(28건)

**주요 번식지**
- 화분 받침대, 에어컨 응결수 받이, 발코니 양동이·물통, 배수구 등에서 번식 발견

**⚠️ 한인 가정 예방 수칙**
- 화분 받침대·에어컨 물받이 등 고인 물 **주 1회 이상 비우기**
- 외출 전 **NEA myENV 앱 또는 nea.gov.sg**에서 클러스터 위치 확인
- 고열·극심한 두통·관절통 시 GP/폴리클리닉 방문, 뎅기열 검사(NS1) 요청
...
정확한 내용은 원문(아래 출처)을 확인하세요.`,
    ...
    sources: [
      ...
      { name: "NEA — Dengue Clusters Under Surveillance", url: "https://www.nea.gov.sg/dengue-zika/dengue/dengue-clusters-under-surveillance" },
    ],
    time: "2026년 8월",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "🎓 NTU, AI 탐지 도구 올해말 전면 폐지 — '근본적으로 신뢰 불가', AI 공시 양식으로 대체",
    summary: "난양공대(NTU)가 현재 사용 중인 AI 글쓰기 탐지 도구를 2026년 12월31일까지 전면 비활성화한다고 8월15일 밝혔다. 현재 AI 탐지기가 '근본적으로 신뢰 불가'하며 책임감 있는 AI 활용과 부정행위를 구별하지 못한다는 이유다. 2025년 AI 사용 혐의로 낙제 처리된 학생 3명의 논란이 계기가 됐으며, 앞으로는 AI 사용 공시 양식을 통한 사후 검증으로 전환된다.",
    fullContent: `**NTU AI 탐지 도구 폐지 결정 (2026년 8월 15일)**
난양공대(NTU)가 캠퍼스 내 AI 탐지 도구 사용을 올해 말 전면 중단하기로 했습니다.

**결정 내용**
- **2026년 12월 31일까지** AI 글쓰기 탐지 도구 전면 비활성화
- 대학 측: 현재 AI 탐지기는 **"근본적으로 신뢰 불가(fundamentally unreliable)"**하다고 발표
- 탐지 점수·경고는 **결정적 증거가 아닌 불확실한 자료**로만 취급하도록 교수진에 지침 변경

**계기**
- 2025년 한 강의에서 AI 사용 혐의로 3명의 학생이 낙제 처리됐고, 학생들이 이를 이의 제기한 논란

**새 방향**
- 자동 탐지 대신 **AI 사용 공시 양식(standardised disclosure form)**을 통한 사후 검증으로 전환
- 교수진은 AI 탐지기를 '위협'으로 묘사하지 말고, 학생의 작업 과정을 문서화하는 방식으로 평가 전환

**한인 가정 참고**
- NTU 재학 중인 자녀가 있다면 AI 공시 양식 절차 및 각 강의의 AI 사용 규정을 직접 확인하세요.
- 과제에서 AI를 어떻게 사용했는지 기록해두는 습관이 중요해집니다.

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "Mothership · The Online Citizen",
    sources: [
      { name: "The Online Citizen — NTU to discontinue AI detection tool from 2027 citing reliability concerns", url: "https://theonlinecitizen.com/2026/08/15/ntu-to-discontinue-ai-detection-tool-from-2027-citing-reliability-concerns" },
      { name: "Mothership — NTU to stop using AI detectors from 2027", url: "https://mothership.sg/2026/08/ntu-stop-ai-detectors-2027/" },
    ],
    time: "2026년 8월 15일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "생활",
    catStyle: "bg-[#F5F0FF] text-[#7040C0]",
    title: "🚇 8월29일부터 AXS 기기서 EZ-Link·SimplyGo 충전 불가 — 12일 후 종료, 대안 미리 확인을",
    summary: "8월29일(토)부터 AXS 셀프서비스 단말기에서 EZ-Link 및 SimplyGo EZ-Link 카드를 충전할 수 없게 된다. SimplyGo 공식 안내에 따른 변경이며, 대안으로는 MRT역 내 Add Value Machine(AVM), 편의점, EZ-Link 모바일 앱을 이용할 수 있다.",
    fullContent: `**AXS 기기 EZ-Link 충전 서비스 종료 — 8월 29일부터**
평소 AXS 단말기로 교통카드를 충전해왔다면, 지금 바로 대안을 확인하세요.

**변경 내용**
- **2026년 8월 29일(토)부터** AXS 기기(은행 자동화기기형 셀프서비스 단말기)에서 EZ-Link 카드 및 SimplyGo EZ-Link 카드 **충전 서비스 종료**
- SimplyGo 공식 웹사이트에 안내 중

**대안 충전 방법**
- **MRT역 Add Value Machine(AVM)**: 역 내 설치된 전용 충전기
- **편의점**: 세븐일레븐 등에서 현금 충전 가능
- **EZ-Link 앱**: 앱 스토어에서 다운로드 후 은행 계좌·신용카드 연결해 충전
- **SimplyGo**: 신용·체크카드로 버스·MRT 직접 결제도 가능

**한인 참고**
- AXS는 교통카드 충전 외에도 공공요금·통신비 납부 등 다양한 용도로 쓰이므로 기기 자체가 없어지는 것은 아닙니다. 충전 기능만 종료됩니다.
- 8월 29일 이전에 미리 충전하거나 대안 방법 설정을 해두세요.

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "SimplyGo (공식)",
    sources: [
      { name: "SimplyGo — 공식 EZ-Link 안내", url: "https://simplygo.com.sg/ezlink" },
    ],
    time: "2026년 8월",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "👷 9월1일 NTS 직종 목록 8개 확대 — F&B·사회서비스·항공 Work Permit 채용 범위 넓어져",
    summary: "인력부(MOM)의 비전통 출신국(NTS) 직종 목록이 9월1일부터 확대된다. 요리사·주방보조·홀직원·사회서비스 보조인력·항공운송 관련 직종 등 8개가 추가돼 해당 업종에서 NTS 국가 출신 Work Permit 소지자를 채용할 수 있게 된다. 최저 월급 S$2,000 이상 조건. F&B 업소를 운영하는 한인 사업주에게 직접 관련된 변화다.",
    fullContent: `**MOM NTS 직종 목록 확대 — 9월 1일 시행**
인력부(MOM)가 올해 3월 발표하고 9월 1일 시행되는 비전통 출신국(Non-Traditional Sources, NTS) 직종 목록 확대 내용입니다.

**변경 내용**
- **9월 1일부터 8개 직종 추가** — 음식서비스·사회서비스·항공운송 분야
- 추가된 직종(예시): 요리사(Cook), 주방보조(Kitchen Assistant), 홀직원(Waiter), 식재료 준비원(Butcher/Fishmonger), 식음료 스탠드 직원(Food/Drink Stall Assistant), 사회서비스 보조인력, 항공운송 관련 직종
- 최저 월급: **S$2,000 이상** (Work Permit 소지자)

**NTS 국가란?**
인도·방글라데시·미얀마·스리랑카·파키스탄 등 '비전통 출신국'으로 분류된 국가 출신 외국인 근로자. 이번 확대로 F&B 등 새 분야에서도 NTS 국가 출신 WP 소지자 채용이 가능해진다.

**한인 사업주 참고**
- F&B 식당 운영 중이라면 9월 1일부터 위 직종에 NTS 국가 출신 Work Permit 소지자를 채용할 수 있습니다.
- 단 WP 쿼터·레비 규정은 별도로 적용되며, 상세 조건은 MOM 공식 안내를 확인하세요.
- S Pass 최저급여가 2027년 1월부터 S$3,600으로 인상되는 것과 별개의 제도입니다.

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "MOM · Singapore Employment Agency",
    sources: [
      { name: "MOM — Factsheet on Foreign Workforce Policies (March 2026)", url: "https://www.mom.gov.sg/-/media/mom/documents/press-releases/2026/factsheet-on-foreign-workforce-policies-03032026.pdf" },
      { name: "Singapore Employment Agency — NTS-OL Expansion September 2026", url: "https://singaporeemploymentagency.com/singapore-nts-ol-expansion-september-2026/" },
    ],
    time: "2026년 9월 1일 시행",
    isBreaking: false,
    readTime: "2분",
