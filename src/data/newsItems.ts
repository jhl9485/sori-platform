...
const RAW_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    title: "📈 MAS 7월 27일 SGD 환율정책 깜짝 긴축 — 4월 이어 올해 두 번째, 중동발 물가 압력 반영",
    summary: "싱가포르 통화청(MAS)이 7월 27일 SGD 명목실효환율(S$NEER) 정책 밴드의 절상 속도를 '매우 소폭' 높이는 추가 긴축을 단행했다. 4월에 이은 올해 두 번째 결정으로, 시장 전망(동결)을 깨고 나온 깜짝 조치다. MAS는 중동 사태發 에너지가격 상승으로 인플레이션 위험이 지속되고 있다고 밝혔다. 2026년 근원물가·CPI 전망은 1.5~2.5%로 유지됐으며, SGD는 한국 원화(KRW) 대비 역사적 강세 구간(2026년 5월 고점 1,171 KRW)에 있어 한국 송금 환율이 우호적이다.",
    fullContent: `**MAS 7월 27일 통화정책 결정 (싱가포르 통화청)**
싱가포르 통화청(MAS)이 7월 27일 정례 외 일정으로 통화정책을 추가 긴축했습니다.

**결정 내용**
- **SGD NEER(명목실효환율) 정책 밴드의 절상 속도를 '매우 소폭' 상향** — 밴드의 폭·중간값은 유지
- 4월 긴축에 이은 **2026년 두 번째 긴축**, 이전 4월보다는 작은 폭
- 로이터가 사전 조사한 이코노미스트 대다수는 동결을 예상했던 터라 **깜짝 결정**으로 평가

**이유**
- **중동 긴장 지속**에 따른 에너지 가격 상승 → 인플레이션 위험 지속
- 경제 성장 견조, **아웃풋 갭이 플러스**로 전환 — 수요 측 인플레 압력 추가
- 2026년 **근원물가·CPI 전망 1.5~2.5%** 유지

**한인 생활 영향**
- MAS 긴축 → SGD 추가 강세 압력 → **한국 원화(KRW) 대비 SGD 유리**
- 2026년 5월 S$1 = 1,171 KRW 역대 최고, 8월 현재도 1,130~1,160 KRW 수준
- 한국 송금을 자주 하는 한인에게는 유리한 환경 — Wise·Instarem 등 환율 알림 설정 권장
- 에너지 물가 압력이 지속되므로 전기 사용량 관리에도 유의

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "MAS · CNBC · The Edge Singapore",
    sources: [
      { name: "MAS — Monetary Policy Statement July 2026 (공식)", url: "https://www.mas.gov.sg/news/monetary-policy-statements/2026/mas-monetary-policy-statement-27jul26" },
      { name: "CNBC — Singapore tightens monetary policy in surprise move (July 27, 2026)", url: "https://www.cnbc.com/2026/07/27/singapore-mas-july-monetary-policy-middle-east-oil-prices-inflation-.html" },
      { name: "The Edge Singapore — MAS tightens monetary policy again in July", url: "https://www.theedgesingapore.com/news/singapore-news/mas-tightens-monetary-policy-again-july" },
    ],
    time: "2026년 7월 27일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "🌫️ NEA '다음 주 연무 위험 높아질 수 있다' 경보 — 8/9 PSI 81(중급 상위), 건조 날씨·인근 화재 지속",
    summary: "싱가포르 국가환경청(NEA)이 8월 9일 건조한 날씨가 이어지면서 다음 주 연무 위험이 높아질 수 있다고 경보했다. 8월 9일 오후 1시 기준 중부 지역 24시간 PSI는 81로 '중급(Moderate)' 상위에 해당했다. SIIA 'Haze Outlook 2026'이 경고한 '피크 위험기(8~9월)'가 현실화되는 양상이며, 정부 연무대응팀(Haze Task Force, 28개 기관)이 PSI 100 초과 시 가동 준비를 마친 상태다.",
    fullContent: `**싱가포르 연무 위험 경보 (NEA, 2026년 8월 9일)**
8월 9일 건국기념일, 야외 행사가 많은 날에 연무 위험 경보가 나왔습니다.

**현황**
- 8월 9일 오후 1시 기준 중부 지역 **24시간 PSI: 81** (중급 상위 — 100 미만이나 높은 편)
- NEA는 건조한 날씨가 이어지면 **다음 주 연무 위험이 더 높아질 수 있다**고 경보

**원인**
- 인도네시아·말레이시아 등 인근 지역 화재(핫스팟) 지속 + 건조 기후 유지
- 연기가 바람을 타고 싱가포르 방향으로 유입될 가능성 커짐

**대비**
- 정부 **연무대응팀(Haze Task Force, 28개 기관)**이 PSI 100 초과 시 각 부처 연무 대응 계획 가동 준비 완료
- 참고: SIIA 'Haze Outlook 2026'은 6월에 이미 **8~9월을 피크 위험기**로 경고(2026 두 번째 레드 등급)

**한인 가정 행동 가이드**
- 야외 운동·야외 행사는 PSI 100 미만에서는 가능하나, 민감군(호흡기 질환자·영유아·노약자)은 PSI 50 이하로 낮아지면 재개 권장
- 외출 전 **NEA myENV 앱** 또는 **haze.gov.sg**에서 1시간 PM2.5·24시간 PSI 확인
- N95 마스크·공기청정기 미리 준비 권장

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "NEA · The Star",
    sources: [
      { name: "The Star — Risk of haze in Singapore if dry conditions, regional hot spots continue (Aug 9, 2026)", url: "https://www.thestar.com.my/aseanplus/aseanplus-news/2026/08/09/risk-of-haze-in-singapore-if-dry-conditions-regional-hot-spots-continue-in-the-coming-week" },
      { name: "Singapore Uncensored — Haze Risk In Singapore Could Rise Next Week As Dry Weather Persists: NEA", url: "https://singaporeuncensored.com/haze-risk-in-singapore-could-rise-next-week-as-dry-weather-persists-nea/" },
    ],
    time: "2026년 8월 9일",
    isBreaking: true,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "안전",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "📦 iMessage 택배사 사칭 피싱 급증 — 8/5까지 251건·S$120만 손실, '답장 Y하면 링크 활성화' 신수법",
    summary: "싱가포르 경찰(SPF)이 8월 5일 Apple iMessage를 이용한 택배사 사칭 피싱 사기 경보를 발령했다. 6월 24일 이후 251건, S$120만 이상 피해. +212(모로코)·+63(필리핀)·+44(영국) 등 해외 번호나 영숫자 이메일로 DHL·NinjaVan·J&T Express·SingPost를 사칭한 '주소 갱신' 문자가 오며, 'Y' 또는 '1'로 답장하도록 유도해 Apple 내장 링크 차단을 우회하는 신수법이 확인됐다.",
    fullContent: `**iMessage 택배사 사칭 피싱 사기 경보 (SPF, 2026년 8월 5일)**
싱가포르 경찰청(SPF)이 8월 5일 업데이트 경보를 발령했습니다.

**피해 현황**
- 6월 24일 이후 최소 **251건** 신고, 피해액 최소 **S$120만(S$1.2 million)**
- 7월 15일 1차 경보 당시(43건·S$25만9천)보다 건수·피해 모두 급증

**수법 — Apple iMessage 내장 차단 우회 신수법**
1. +212(모로코)·+63(필리핀)·+44(영국) 등 해외 번호 또는 영숫자 이메일 주소로 iMessage 발신
2. 사칭 대상: **DHL, NinjaVan, J&T Express, SingPost** 등 실제 택배사
3. "주소 오류로 배송 불가, 24시간 내 갱신 필요" 문자 + 피싱 링크 포함
4. **핵심 우회 수법**: 발신자가 '모르는 사람'으로 분류되면 Apple은 링크를 비활성화. 이에 사기범은 피해자에게 "확인 시 Y 또는 1로 답장하라" 요청 → 답장 시 발신자가 '아는 사람'으로 변경 → **링크 활성화**

**예방 수칙**
- 해외 번호·낯선 주소로 온 배송 관련 문자는 **절대 답장하지 말 것**
- '주소 갱신'·'미납 배송비' 명목 링크는 클릭하지 말고, 해당 택배사 공식 앱·웹사이트에서 직접 확인
- 이미 정보를 입력했다면 즉시 은행에 연락해 카드 정지 요청

**한인 주의 팁**
- 한국 쇼핑몰·배송대행지 이용 시 실제 국제 배송 건이 있는 경우 이런 사기 문자를 진짜로 혼동할 수 있음 — 반드시 공식 채널로 따로 확인할 것
- ScamShield 앱 또는 1799(안티스캠 핫라인)에 신고

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "SPF · The Independent SG",
    sources: [
      { name: "SPF — Police Advisory On Phishing Scams Impersonating Courier Companies Via Apple iMessage (공식, 8/5)", url: "https://www.police.gov.sg/Media-Hub/News/2026/08/20260805_police_advisory_on_phishing_scams_impersonating_courier_companies_via_apple_imessage" },
      { name: "The Independent Singapore — 251 victims, S$1.2 million gone: The iMessage courier scam that bypasses Apple's built-in protection", url: "https://theindependent.sg/251-victims-s-1-2-million-gone-the-imessage-courier-scam-that-bypasses-apple-s-built-in-protection/" },
      { name: "Tabla — S$259,000 lost in courier phishing scams (7/15 1차 경보)", url: "https://www.tabla.com.sg/news/singapore/s259000-lost-so-far-new-phishing-scam-involves-courier-companies" },
    ],
    time: "2026년 8월 5일",
    isBreaking: true,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "건강",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "🦟 뎅기열 8월 1일 주 119건 · 17개 클러스터 — 렌터·컨트리사이드로드 228건 최대, 피크 시즌 진행 중",
    summary: "싱가포르 국가환경청(NEA)에 따르면 8월 1일로 끝나는 주에 뎅기열 119건이 확진됐다. 2026년 누적 1,700건 이상. 현재 17개 활성 클러스터(그중 6개 블랙스팟, 누적 10건+). 가장 큰 클러스터는 렌터 MRT 인근 컨트리사이드로드·렌터애비뉴(228건)로 빠르게 확산 중이다. 5~10월 피크 시즌이 계속되고 있어 모기 번식원 제거가 중요하다.",
    fullContent: `**뎅기열 8월 동향 (NEA, 8월 1일 주 기준)**
전통적으로 5~10월이 뎅기 피크 시즌인 싱가포르, 8월에도 100건대가 이어지고 있습니다.

**현황**
- 8월 1일로 끝나는 주 **119건** 확진 (8주 연속 100건 이상)
- 2026년 누적: **1,700건 이상**
- 활성 클러스터: **17곳**, 그중 **6곳 블랙스팟** (누적 10건 이상·급속 확산)

**주요 클러스터**
- **컨트리사이드로드/렌터애비뉴** (렌터 MRT 인근): **228건** — 가장 큰 클러스터, 급성장
- **잘란 타리 둘랑/잘란 타리 파용**: 38건
- 모기 번식원: 가정용 컨테이너, 화분 받침, 쓰레기통 등에서 확인됨

**한인 가정 예방 체크리스트**
- 화분 받침대·에어컨 응결수 받이 등 고인 물 **즉시 제거**
- 발코니 양동이·물통 뒤집어 보관, 배수구 주 1회 청소
- 발열·심한 두통·관절통·눈 뒤 통증 시 GP/폴리클리닉 방문, NS1 검사 요청
- 실시간 클러스터 위치는 **NEA myENV 앱** 또는 **nea.gov.sg**의 뎅기 클러스터 맵에서 확인
