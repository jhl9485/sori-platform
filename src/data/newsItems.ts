...
const RAW_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    title: "📱 Apple iMessage 스캠 급증 — 경찰, 3만 계정 차단·피해 S$220만",
    summary: "8월 20일 싱가포르 경찰(SPF)은 6월 이후 Apple iMessage를 악용한 택배사 사칭 스캠으로 피해액이 약 S$220만에 달한다고 발표했다. NinjaVan·J&T Express 등 택배사 사칭 메시지로 시작해 개인정보·계좌 정보를 빼내는 방식이며, 경찰은 3만 개 이상의 스캠 iMessage 계정을 차단했다. 8월 8일에는 iMessage로 싱가포르 경찰청(SPF)·교통경찰(TP)·법원을 사칭해 '교통위반 과태료·체포영장'을 위협하는 별도 수법도 경보했다.",
    fullContent: `**Apple iMessage 스캠 급증 경보 (SPF, 8월 20일)**
싱가포르 경찰청(SPF)이 Apple iMessage를 악용한 다수의 사기 수법을 연달아 경보하고 있습니다.

**① 택배사 사칭 (8월 5일·20일 경보)**
- **NinjaVan·J&T Express·SPX Express** 등 택배 회사를 사칭한 iMessage 발송
- 모르는 번호(+212 모로코, +63 필리핀, +44 영국 등) 또는 무작위 영문숫자 이메일 주소에서 발송
- iMessage의 '모르는 발신자 링크 차단' 기능을 우회하기 위해 "안녕하세요" 등 짧은 답장을 먼저 유도
- **6월 이후 피해액 약 S$220만** (8월 초 S$120만에서 2주 만에 급증)

**② 경찰·법원 사칭 (8월 8일 경보)**
- SPF·교통경찰(TP)·지방법원(District Court)를 사칭한 iMessage 발송
- "교통위반 과태료 미납" "체포영장 발부 예정" 등 위협 후 개인정보·계좌 요구
- 현재까지 금전 피해 보고는 없으나 신고 피해자 다수

**SPF 대응**
- 6월 이후 사이버 커맨드가 **3만 개 이상의 iMessage 스캠 계정 차단·비활성화**

**한인 주의 수칙**
- 싱가포르 정부기관(경찰·법원·교통경찰)은 iMessage·문자로 과태료 납부나 계좌 이체를 요구하지 않음
- 택배 배송 알림은 직접 회사 공식 앱·웹사이트에서 확인
- 의심 메시지는 즉시 차단·신고. ScamShield 앱(1799) 활용

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "SPF (공식)",
    sources: [
      { name: "SPF — 3만 iMessage 계정 차단 (8월 20일)", url: "https://www.police.gov.sg/Media-Hub/News/2026/08/20260820_police_advisory_on_exploitation_of_apple_imessage_by_scammers" },
      { name: "SPF — 경찰·법원 사칭 iMessage (8월 8일)", url: "https://www.police.gov.sg/Media-Hub/News/2026/08/20260808_police_advisory_on_phishing_scams_impersonating_the_singapore_police_force" },
      { name: "SPF — 택배사 사칭 iMessage (8월 5일)", url: "https://www.police.gov.sg/Media-Hub/News/2026/08/20260805_police_advisory_on_phishing_scams_impersonating_courier_companies_via_apple_imessage" },
    ],
    time: "2026년 8월 20일",
    isBreaking: true,
    readTime: "3분",
    emoji: "📱",
    relatedIds: ["auto-20260817-1", "auto-20260813-1"],
  },
  {
    id: "auto-20260817-1",
    ...
    category: "사회",
    catStyle: "bg-[#F5F0FF] text-[#7040C0]",
    title: "🛡️ WhatsApp·텔레그램 새 안티스캠 규정 — 모르는 사람이 그룹 초대 시 동의 필요, 위반 시 최대 S$1,000만 벌금",
    summary: "8월 17일 싱가포르 정부는 '온라인 범죄 피해법(OCHA)' 하에 새 행동규범(Code of Practice) 3종을 발표했다. 이제 WhatsApp·텔레그램·WeChat·Apple iMessage·Google Messages 등은 모르는 사람이 사용자를 단체 채팅방·채널에 추가하기 전에 반드시 동의를 받아야 한다. Facebook·Instagram·TikTok 등 광고 플랫폼은 광고주를 인증해야 한다. 위반 시 최대 S$1,000만 벌금. 대부분 2027년 1월 31일 시행.",
    fullContent: `**새 안티스캠 행동규범 (OCHA, 8월 17일 발표)**
싱가포르 내무부(MHA)가 '온라인 범죄 피해법(Online Criminal Harms Act, OCHA)' 하에 온라인 플랫폼 대상 새 행동규범 3종을 발표했습니다.

**① 메시징 플랫폼 규범**
대상: **WhatsApp, Telegram, WeChat, Apple iMessage, Apple FaceTime, Google Messages, Google Meet**
주요 내용:
- **모르는 연락처가 단체 채팅방·채널에 사용자를 추가하기 전 반드시 동의(consent) 획득** 필요
- 모르는 번호로부터 오는 메시지·통화에 경고 표시·위험 지표 제공
- 연락처에 없는 번호의 메시지를 필터링·차단하는 옵션 제공
- 싱가포르 정부 기관을 사칭한 프로필명·사진 방지: **9월 30일까지 시행**
- 전체 시행 기한: **2027년 1월 31일**

**② 소셜미디어 플랫폼 규범**
대상: Facebook, Instagram, TikTok, YouTube 등
주요 내용: **광고주 인증 의무화**

**③ 전자상거래 플랫폼 규범**
대상: Lazada, Shopee 등
주요 내용: 판매자 신원 확인·사기 신고 처리 절차

**벌금**
미준수 시 건당 최대 **S$1,000만**, 계속 미이행 시 일당 **S$30만** 추가

**한인 참고**
- 모르는 번호에서 오는 WhatsApp/Telegram 단체초대 수락 전 한 번 더 확인
- 이 규정 시행 후에도 규정 위반 스캠 시도는 계속될 수 있으므로 상시 주의

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "MHA · Mothership",
    sources: [
      { name: "Mothership — 메시징·소셜미디어 새 안티스캠 규정 (8월 17일)", url: "https://mothership.sg/2026/08/social-media-implement-new-safeguards/" },
      { name: "The Online Citizen — 새 안티스캠 규정·최대 S$1,000만 벌금", url: "https://theonlinecitizen.com/2026/08/18/new-anti-scam-rules-to-target-whats-app-telegram-facebook-and-tik-tok-in-singapore" },
      { name: "MissLobang — 새 안티스캠 규정 정리 (한인용)", url: "https://www.misslobang.com/article/singapore-anti-scam-codes-of-practice-whatsapp-telegram-2026" },
    ],
    time: "2026년 8월 17일",
    isBreaking: false,
    readTime: "3분",
    emoji: "🛡️",
    relatedIds: ["auto-20260820-1", "auto-20260813-1"],
  },
  {
    id: "auto-20260818-1",
    ...
    title: "🌫️ 연무 실제 악화 — PSI 81 도달, NEA '건기 지속 시 추가 상승 가능'",
    summary: "수마트라·칼리만탄 지역 화재가 지속되면서 8월 9일 싱가포르 중부 지역 24시간 PSI가 81까지 올랐다. NEA는 건기와 남동~남서풍이 계속될 경우 PSI가 추가로 상승할 수 있다고 경고했다. 8월 18일 기준 건기는 이어지고 있으며, 수마트라·칼리만탄 화재 연기가 유입될 위험이 남아 있다. 6월 SIIA 전망대로 8~9월이 최고 위험기에 해당한다.",
    fullContent: `**연무(Haze) 실제 악화 경보 (2026년 8월)**
올해 연무 시즌이 실제 악화 단계에 접어들었습니다. 야외 활동 계획 시 참고하세요.

**현황 (8월 18일 기준)**
- **8월 9일** 싱가포르 중부 지역 24시간 PSI **81** 기록 — '보통(Moderate)' 범위 상단
- 수마트라 남부·칼리만탄 지역 화재 핫스팟 지속, 남동~남서풍으로 연무 유입
- NEA: "건기 지속 및 풍향에 따라 PSI 추가 상승 가능"
- 8월 18일 기준 건기 이어지며 연무 유입 위험 지속

**건강 권고 기준**
- PSI 0~100: 보통 — 일반 활동 무방
- PSI 101~200: 건강하지 않음 — 야외 운동 자제, 마스크(N95) 착용
- PSI 201 이상: 매우 건강하지 않음 — 불필요한 외출 자제

**한인 가정 실천 수칙**
- 외출 전 **haze.gov.sg** 또는 **NEA myENV 앱**에서 실시간 PM2.5·PSI 확인
- 영유아·노약자·호흡기 질환자는 PSI 80 이상부터 실내 활동 권장
- N95 마스크는 약국·FairPrice·NTUC 등에서 구입 가능 (의약외품 규격 확인)
- 에어컨 필터 청소 주기 단축 — 연무 기간 중 실내 PM2.5 관리에 도움

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "Mothership · Malay Mail · NEA",
    sources: [
      ...
      { name: "Malay Mail — Dry spell puts Singapore on haze watch as Sumatra, Kalimantan fires persist (8월 18일)", url: "https://www.malaymail.com/news/singapore/2026/08/18/dry-spell-puts-singapore-on-haze-watch-as-sumatra-kalimantan-fires-persist/231733" },
      { name: "Malay Mail — Haze risk rises: Singapore task force ready if PSI tops 100 (8월 10일)", url: "https://www.malaymail.com/news/singapore/2026/08/10/haze-risk-rises-singapore-task-force-ready-if-psi-tops-100/230772" },
    ],
    time: "2026년 8월 18일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "사회",
    catStyle: "bg-[#F5F0FF] text-[#7040C0]",
    title: "🚔 경찰 2주 단속 — 사기범·머니뮬 270명 조사, S$540만 피해·660건 이상",
    summary: "7월 30일~8월 12일 2주간 SPF 사이버 커맨드·7개 경찰청 합동 작전 결과, 15~80세 남성 185명·여성 85명(총 270명)이 조사를 받고 있다. 전자상거래·피싱·취업·정부기관 사칭·투자·행운권 사기 등 660건 이상, 피해액 약 S$540만으로 집계됐다. 사기 가담 시 최대 징역 10년·가담자 의무 태형 6~24대가 적용될 수 있다.",
    fullContent: `**경찰 전국 사기 단속 결과 (SPF, 8월 13일 발표)**
싱가포르 경찰청이 7월 30일~8월 12일 2주간 별인 '전국 단속 작전' 결과를 8월 13일 발표했습니다.

**주요 수치**
- **조사 인원: 270명** (남 185명·여 85명, 15~80세)
- **연관 사건: 660건 이상** / **피해액 약 S$540만**
- 단속 기간: 7월 30일(수) ~ 8월 12일(화)

**사기 유형**
전자상거래·피싱·취업·정부기관 사칭·투자·행운권 사기 등

**처벌**
- **사기죄(Cheating, 형법 420조)**: 징역 최대 10년 + 벌금
- **사기 가담자·조직원·모집책**: 의무 태형 **6~24대**
- **머니뮬(계좌 대여)**: 자금세탁죄 + 허가 없는 결제서비스 제공죄

**한인 주의**
- '쉽게 돈 버는 아르바이트'로 본인 계좌를 빌려주면 **머니뮬 공범**이 될 수 있음
- 의심되면 ScamShield 앱(1799) 또는 경찰 신고 **1800-255-0000**

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "SPF (공식)",
    sources: [
      { name: "SPF — 270명 단속 결과 (8월 13일 공식 발표)", url: "https://www.police.gov.sg/Media-Hub/News/2026/08/20260813_police_investigate_270_scammers_and_money_mules_in_islandwide_enforcement_operation" },
      { name: "The Independent Singapore — 270 suspected scammers nabbed", url: "https://theindependent.sg/270-suspected-scammers-and-money-mules-nabbed-in-two-week-operation-linked-to-s-5-4m-in-losses/" },
    ],
    time: "2026년 8월 13일",
    isBreaking: false,
    readTime: "2분",
    emoji: "🚔",
    relatedIds: ["auto-20260820-1", "auto-20260817-1"],
  },
  {
    id: "auto-20260822-1",
    ...
    category: "교통",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "🚇 8월 29일부터 AXS에서 EZ-Link 충전 불가 — SimplyGo 앱·편의점으로 이동",
    summary: "8월 29일(금)부터 AXS 스테이션에서 EZ-Link 및 SimplyGo EZ-Link 카드 충전(top-up) 서비스가 종료된다. 이후에는 SimplyGo 앱, MRT 역 충전기, FairPrice·세븐일레븐 등 편의점, EZ-Link 공식 앱을 이용해야 한다. 정기권(아이 등 특정 카드) 사용자는 영향 없음.",
    fullContent: `**AXS EZ-Link 충전 서비스 종료 (2026년 8월 29일)**
8월 29일(금)부터 주요 MRT역·쇼핑몰 등에 설치된 AXS 스테이션에서 EZ-Link 및 SimplyGo EZ-Link 카드를 충전할 수 없게 됩니다.

**변경 내용**
- **종료 일시**: 2026년 8월 29일(금)부터
- **종료 서비스**: AXS 스테이션에서의 EZ-Link·SimplyGo EZ-Link 카드 top-up

**대안 충전 방법**
1. **SimplyGo 앱** — 스마트폰 앱에서 직접 충전 (신용·체크카드 연동)
2. **MRT 역 내 Passenger Service Centre·Ticket Machine** — 역 내 단말기에서 충전 가능
3. **FairPrice·세븐일레븐 등 편의점** — 카운터에서 충전 가능
4. **EZ-Link 공식 앱** — 모바일로 충전

**한인 참고**
- 매주 AXS에서 충전하던 습관이 있다면 이 날짜 전에 대안 방법으로 전환할 것
- 스마트폰에 SimplyGo 앱 설치·카드 등록이 가장 편리한 대안
- 아이 통학 전용 카드 등 정기권은 이번 변경에 영향받지 않음

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "SimplyGo (공식)",
    sources: [
      { name: "SimplyGo 공식 사이트 — AXS 충전 종료 공지", url: "https://simplygo.com.sg/" },
      { name: "Smart Calculator SG — Singapore MRT & Bus Fare Guide 2026 (AXS 변경 언급)", url: "https://www.smartcalculator.sg/articles/singapore-mrt-bus-fare-guide-2026" },
    ],
    time: "2026년 8월 22일",
    isBreaking: false,
    readTime: "2분",
