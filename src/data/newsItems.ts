...
const RAW_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    title: "📊 7월 물가 +2.2% — 약 2년 만에 최고, 에너지발(發) 상승·GDP 전망 4.5~5.5%로 상향",
    summary: "싱가포르 통계청이 8월 24일 발표한 7월 CPI는 전년 동기 대비 +2.2%로, 2024년 8월 이후 약 2년 만에 가장 높은 수준이다(6월 +1.9%). 근원물가도 +2.0%로 2024년 10월 이후 최고치. 중동(이란) 분쟁으로 인한 천연가스 가격 상승이 전기·가스 요금과 교통비를 끌어올렸다. 한편 정부는 2026년 GDP 성장률 전망을 기존 2~4%에서 4.5~5.5%로 대폭 상향했다.",
    fullContent: `**싱가포르 7월 소비자물가 지표 (8월 24일 발표)**

**CPI (소비자물가지수) 7월**
- 전년 동기 대비 **+2.2%** — 2024년 8월 이후 **약 2년 만에 최고치**
- 전월(6월) +1.9%에서 상승 / 시장 예상 +2.3%는 소폭 하회
- 근원물가(Core CPI, 주거·민간교통 제외) **+2.0%** — 2024년 10월 이후 최고치

**상승 주요 원인**
- 중동(이란) 분쟁으로 천연가스 가격 상승 → **전기·가스 요금 인상, 교통비 상승** 반영
- MAS는 2026년 연간 CPI 전망 1.5~2.5% 유지

**GDP 성장률 전망 상향**
- 정부 2026년 GDP 전망 **2.0~4.0% → 4.5~5.5%** 대폭 상향
- AI 관련 반도체·데이터센터 수요, 건설·금융 부문 성장세 반영

**한인 생활 영향**
- 전기요금·교통비 추가 상승 가능성 지속 — 고정요율(fixed-price) 전기 플랜 비교 검토
- SGD 강세 유지 시 한국 송금 환율에 유리한 흐름

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "Bloomberg · CNBC · RTTNews",
    sources: [
      { name: "Bloomberg — Singapore Core Inflation Surges to Near Two-Year High (Aug 24)", url: "https://www.bloomberg.com/news/articles/2026-08-24/singapore-core-inflation-surges-to-near-two-year-high-on-energy" },
      { name: "CNBC — Singapore inflation hits highest in nearly two years (Aug 24)", url: "https://www.cnbc.com/2026/08/24/singapore-inflation-budget-iran-war.html" },
      { name: "RTTNews — Singapore Inflation Climbs To 2.2%, Highest In Nearly 2 Years", url: "https://www.rttnews.com/story.aspx?Id=3683444" },
      { name: "FX.co — Singapore Core Inflation Quickens to 2.0% in July", url: "https://www.fx.co/en/forex-news/3111514" },
    ],
    time: "2026년 8월 24일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "🧒 NDR 2026: 시민권 자녀 1인당 최대 S$6만2천 — 베이비보너스 통합·육아휴가 최대 12일",
    summary: "로런스 웡 총리가 8월 23일 국경일 Rally(NDR 2026)에서 자녀 지원 대폭 확대를 발표했다. 'SG Child Support Package'로 싱가포르 시민권 자녀 1인당 출생~17세 동안 최대 S$62,000의 신규 혜택(기존 포함 총 약 S$70,000)을 지급하며, 기존 베이비보너스·대가족 지원을 통합·단순화한다. 2027년 4월 시행 예정. 맞벌이 부모의 육아 휴가도 자녀 수에 따라 최대 12일로 늘어난다.",
    fullContent: `**NDR 2026 — SG Child Support Package & 육아휴가 확대 (8월 23일)**
로런스 웡 총리가 국경일 Rally 연설(NDR 2026)에서 발표한 자녀 지원 패키지입니다.

**SG Child Support Package — 시민권 자녀 1인당 최대 S$62,000 신규 혜택**
- **S$10,000 Baby Gift(현금)**: 출생 후 12개월 이내 2회 분할 지급
- **S$32,000 Child Credits(현금)**: 만 1세~만 16세까지 매년 S$2,000, 16년간 지급
- **CDA First Step Grant S$5,000** + 정부 1:1 공동지원(최대 S$5,000)
- **PSEA(고등교육 계정) S$10,000 추가 적립**
- 기존 혜택 포함 시 총 약 **S$70,000** 수준
- 기존 베이비보너스·대가족 지원 **통합·단순화** → 자녀 수 무관 동일 지원
- **2027년 4월 시행** 예정 / 약 61만 명 어린이(38만 가구) 혜택

**육아휴가 확대 — 자녀 수 연동**
- 자녀 1명 8일, 2명 이상 12일 (부모 각각)
- 정부가 법정 자녀 관련 휴가 비용 전액 부담

**한인 가정 참고**
- 이번 혜택은 **싱가포르 시민권 자녀**가 주 대상입니다. PR·외국인 자녀는 일부 혜택만 해당될 수 있으니 life.gov.sg에서 본인 상황에 맞는 적용 범위를 확인하세요.

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "PMO · Made For Families · NTUC",
    sources: [
      { name: "PMO — National Day Rally 2026 (공식)", url: "https://www.pmo.gov.sg/newsroom/ndr2026/" },
      { name: "Made For Families — NDR 2026 Supporting Families (공식)", url: "https://www.madeforfamilies.gov.sg/ndr-2026-supporting-families" },
      { name: "AsiaOne — NDR 2026: S$62,000 Child Support Package 발표", url: "https://www.asiaone.com/singapore/ndr-2026-singaporean-children-receive-62000-under-new-support-package" },
      { name: "NTUC — 육아휴가 최대 12일", url: "https://www.ntuc.org.sg/uportal/news/National-Day-Rally-2026-Singapore-parents-to-get-up-to-12-days-of-childcare-leave/" },
      { name: "Mothership — Baby Bonus replaced by new S$62K package", url: "https://mothership.sg/2026/08/baby-bonus-replaced-new-support-ndr-2026/" },
    ],
    time: "2026년 8월 23일",
    isBreaking: true,
    readTime: "3분",
  ...
  },
  {
    ...
    title: "🧴 HSA, 미큐브 크림 판매 중단·회수 — 금지 성분 '수단 레드' 의심, 즉시 사용 중단",
    summary: "싱가포르 보건과학청(HSA)이 8월 21일 한국 뷰티 브랜드 미큐브(Medicube)의 'PDRN 핑크 콜라겐 캡슐 크림' 판매 중단 및 회수를 발표했다. 금지 색소 '수단 레드(Sudan Red)'가 검출됐다는 홍콩 세관 당국의 7월 보고가 발단이다. 수단 레드는 잠재적 발암성·알레르기 반응을 유발할 수 있어 싱가포르 화장품 규정상 사용이 금지돼 있다. 해당 제품을 구매한 소비자는 즉시 사용을 중단하고 반환·환불을 요청할 것을 권고한다.",
    fullContent: `**HSA 회수 조치 — 미큐브 PDRN 핑크 콜라겐 캡슐 크림 (8월 21일)**

한인이 많이 사용하는 한국 뷰티 브랜드 미큐브(Medicube) 제품이 싱가포르에서 회수 조치를 받았습니다.

**회수 제품**
- **Medicube PDRN Pink Collagen Capsule Cream** (미큐브 PDRN 핑크 콜라겐 캡슐 크림)

**이유**
- 금지 색소 **수단 레드(Sudan Red)** 함유 의심
- 수단 레드는 싱가포르 화장품 규정(Health Products Regulations 2007)상 **사용 금지 성분**으로, 잠재적 발암성(carcinogenic) 및 알레르기 반응 유발 우려

**경위**
- 7월 홍콩 세관 정부실험실이 홍콩 시장 유통 제품에서 수단 레드 검출 보고
- HSA가 8월 21일 싱가포르 내 유통 3개 업체에 판매 중단 및 회수 조치 요청
- 미큐브 측은 한국 실험실 검사에서 10ppm 기준 '미검출'이라며 이의를 제기

**소비자 행동 요령**
- 해당 제품 보유 중이면 **즉시 사용 중단**
- 구매처에 반환 또는 환불 요청 가능
- 피부 이상 반응이 있으면 의사와 상담

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "HSA · AsiaOne · Mothership",
    sources: [
      { name: "AsiaOne — Medicube PDRN Cream recalled in Singapore over suspected Sudan Red", url: "https://www.asiaone.com/singapore/medicube-pdrn-pink-collagen-capsule-cream-recall-singapore-sudan-red-hsa" },
      { name: "Mothership — HSA working with companies to halt sales & recall Medicube cream", url: "https://mothership.sg/2026/08/hsa-recall-medicube-pdrn-pink-collagen-capsule-cream/" },
      { name: "Goody Feed — HSA Recalling Medicube Cream Over Suspected Prohibited Ingredient", url: "https://goodyfeed.com/hsa-is-recalling-a-medicube-cream-in-spore-over-a-suspected-prohibited-ingredient/" },
      { name: "Dr Rachel Ho — Medicube Sudan Red Scandal (성분 설명)", url: "https://www.drrachelho.com/blog/medicube-pdrn-pink-collagen-cream-sudan-red-scandal/" },
    ],
    time: "2026년 8월 21일",
    isBreaking: true,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "사회",
    catStyle: "bg-[#F5F0FF] text-[#7040C0]",
    title: "🚔 경찰 2주 단속 270명 적발 — 사기 660여 건·피해 S$540만, 8/17~21 머니뮬 20명 추가",
    summary: "싱가포르 경찰청(SPF)이 7월 30일~8월 12일 전국 단속으로 사기·머니뮬 혐의자 270명(남 185·여 85)을 조사했다고 8월 13일 발표했다. 연루된 사기 660여 건, 피해액 약 S$540만. 돈세탁·사기·무허가 결제서비스 운영 혐의가 포함됐다. 이어 8월 17~21일에는 정부기관 사칭·취업·전자상거래·투자·인터넷 로맨스·성인 서비스 사기 관련 머니뮬 20명이 추가 검거됐다.",
    fullContent: `**경찰 전국 사기 단속 (SPF 8월 13일·17~21일 발표)**

**7/30~8/12 단속 결과 (8월 13일 발표)**
- **조사 인원: 270명** (남 185·여 85)
- **연루 사건: 660여 건 / 피해액 약 S$540만(S$5.4 million)**
- **혐의**: 돈세탁(money laundering), 사기(cheating), 무허가 결제서비스 운영 등

**추가 체포 (8월 17~21일)**
- **머니뮬 20명 (16~64세)** 검거·기소
- 관련 사기 유형: 정부기관 사칭, 취업, 전자상거래, 투자, 인터넷 로맨스, 성인 서비스

**⚠️ 한인 주의 팁**
- '쉬운 아르바이트'로 본인 계좌·명의를 빌려주면 **머니뮬 공범**이 될 수 있음
- 수익·취업·로맨스 명목의 자금 이체 요구는 즉시 의심할 것
- 의심되면 **ScamShield 앱 / 핫라인 1799**, 신고 1800-255-0000

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "SPF (공식) · ComplyCube",
    sources: [
      { name: "SPF — 270 Scammers And Money Mules Islandwide Operation (공식)", url: "https://www.police.gov.sg/Media-Hub/News/2026/08/20260813_police_investigate_270_scammers_and_money_mules_in_islandwide_enforcement_operation" },
      { name: "ComplyCube — Singapore Scam Investigation $5.4M Loss 270 Suspects", url: "https://www.complycube.com/en/singapore-scam-investigation-270-suspects/" },
      { name: "The Independent SG — 20 money mules arrested Aug 17-21", url: "https://theindependent.sg/spf-20-arrested-for-facilitating-scams-across-six-categories-including-a-teenager-and-a-64-year-old-to-be-charged-from-august-17-to-21/" },
    ],
    time: "2026년 8월 13일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "건강",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "🦟 뎅기 활성 클러스터 17곳·렌터 급증 — 5~10월 피크 시즌, 모기 번식지 제거 촉구",
    summary: "8월 초 기준 싱가포르 뎅기열 주간 신규 확진이 119건이며 전국 활성 클러스터 17곳(이 중 6곳 누적 10건 이상 '레드 알림'). 렌터(Countryside Road/Lentor Avenue) 인근에 빠르게 번지는 대형 클러스터가 형성돼 있어 해당 지역 거주자는 특히 주의해야 한다. NEA는 피크 시즌(5~10월)이 지속 중으로 모기 번식지 제거를 강력히 촉구하고 있다.",
    fullContent: `**뎅기열 클러스터 현황 (2026년 8월 초)**

**수치 (8월 초 기준)**
- 주간 신규 확진: **119건**
- 활성 클러스터: **17곳** (이 중 6곳은 누적 10건 이상 '레드 알림')
- 2026년 누적: 1,700건 이상

**주요 위험 지역**
- **렌터 (Countryside Road/Lentor Avenue) 일대**: 급증 중인 대형 클러스터 — 해당 지역 거주·방문 시 특히 주의
- 모기 번식지 사례: 화분 받침대, 가정용 용기, 쓰레기통의 고인 물

**예방 수칙**
- 집 안팎 고인 물 주 2회 이상 제거(뎅기 모기 Aedes는 실내에서도 번식)
- 모기 기피제 사용, 긴 소매·긴 바지 착용
- 고열·심한 두통·발진이 있으면 진료 시 뎅기 검사 요청
- 최신 클러스터 지도: NEA 공식 사이트(nea.gov.sg → Dengue Clusters)

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "NEA · The Independent SG · AsiaOne",
    sources: [
      { name: "NEA — Dengue Clusters Under Surveillance (공식 지도)", url: "https://www.nea.gov.sg/dengue-zika/dengue/dengue-clusters-under-surveillance" },
      { name: "The Independent SG — 119 cases last week, 17 active clusters", url: "https://theindependent.sg/dengue-cases-fall-to-119-last-week-but-singapore-still-has-17-active-clusters/" },
      { name: "AsiaOne — Fast-growing dengue cluster in Lentor", url: "https://www.asiaone.com/singapore/dengue-cluster-mosquito-countryside-road-lentor-avenue-nea" },
    ],
    time: "2026년 8월",
    isBreaking: false,
    readTime: "2분",
