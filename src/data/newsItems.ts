...
const RAW_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    title: "🚨 싱가포르 반사기법 개정안 의회 상정 — 카루젤·틱톡 계좌 대여도 처벌, 플랫폼 과징금 S$1,000만으로 10배 상향",
    summary: "내무부(MHA)가 8월 4일 '사기(대응) 및 기타 사항 법안(Scams Countermeasures Bill)'을 의회에 1독 상정했다. Facebook·Instagram·TikTok·Carousell 등 9개 플랫폼에서 타인 계좌·개인정보를 대여·수령하는 '계좌 머니뮬'을 처벌(최대 벌금 S$1만·3년 징역·태형 12대)하는 조항이 신설된다. 경찰은 '계좌 비활성화 명령(ADO, 최대 30+30일)'으로 플랫폼에 계좌 비활성화를 명령할 수 있으며, 미준수 플랫폼 과징금은 S$100만→S$1,000만으로 10배 상향된다.",
    fullContent: `**싱가포르 반사기법 개정안 의회 상정 (2026년 8월 4일)**
내무부(MHA)가 8월 4일 '사기(대응) 및 기타 사항 법안(Scams (Countermeasures) and Other Matters Bill)'을 의회에 1독(First Reading) 상정했다.

**새로운 두 가지 명령권**
- **공개명령(Disclosure Order)**: 경찰이 은행·통신사·앱 스토어 등에 특정 계좌 정보·사기 관련 활동 정보를 제공하도록 명령
- **계좌 비활성화 명령(ADO)**: 사기 의심 계좌를 최대 **30일 비활성화**, 필요시 30일 연장 가능

**계좌 머니뮬 처벌 신설**
타인의 계좌·개인정보를 사기에 이용하도록 제공·수령·소지한 '계좌 머니뮬'이 새로 범죄화된다.
- 대상 플랫폼: Facebook, Instagram, WhatsApp, Telegram, WeChat, **TikTok, Carousell**, Google, Apple 등 9곳
- 처벌: 최대 **벌금 S$1만 + 3년 징역 + 태형 12대**

**플랫폼 위반 과징금 10배 상향**
- 현행 최대 **S$100만** → **S$1,000만**
- 위반 지속 시 일별 과징금: S$10만 → S$30만

**한인 팁**
- 온라인 쇼핑(Carousell 등)에서 '대신 계좌로 돈 받아달라'는 요청은 머니뮬이 될 수 있으니 절대 응하지 말 것
- 의심되면 ScamShield(1799) 또는 경찰(1800-255-0000)에 신고

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "MHA · The Star",
    sources: [
      { name: "MHA — Scams Countermeasures Bill 1독 (공식)", url: "https://www.mha.gov.sg/media-room/newsroom/first-reading-of-the-scams-countermeasures-and-other-matters-bill/" },
      { name: "The Star — New anti-scam laws target Carousell, TikTok", url: "https://www.thestar.com.my/aseanplus/aseanplus-news/2026/08/04/new-singapore-anti-scam-laws-target-carousell-tiktok-account-mules-online-harms-order-fine-up-from-s1mil-to-s10mil" },
      { name: "Parliament.gov.sg — Scams Bill (전문)", url: "https://www.parliament.gov.sg/api/media/3a2c5383-13e4-414f-b9cf-4e685c47745d/Scams-Countermeasures-and-Other-Matters-Bill-16-2026.pdf" },
    ],
    time: "2026년 8월 4일",
    isBreaking: false,
    readTime: "3분",
  ...
  },
  {
    ...
    title: "🦟 뎅기열 8월 1일 주 119건·17개 클러스터 — 컨트리사이드로드 228건으로 최대",
    summary: "NEA 집계 기준 8월 1일로 끝나는 주 뎅기열 확진 119건, 2026년 누적 1,700건 이상. 활성 클러스터 17곳 중 6곳이 '블랙스팟(누적 10건 이상)'. 최대 클러스터는 컨트리사이드 로드·렌터 애비뉴 일대(228건)이며, DENV-1 혈청형이 대형 클러스터에서 증가 추세다. NEA는 모기 번식지(고인 물) 제거를 적극 당부했다.",
    fullContent: `**뎅기열 동향 업데이트 (NEA, 2026년 8월 1일 주 기준)**
국가환경청(NEA) 최신 뎅기열 현황입니다.

**주간·누적 현황**
- **8월 1일 주 확진: 119건**
- **2026년 누적: 1,700건 이상**
- 시기: 5~10월 뎅기 성수기 진행 중

**활성 클러스터**
- 총 **17개** 활성 클러스터 / 그중 **6개 블랙스팟** (누적 10건 이상)
- **최대 클러스터: 컨트리사이드 로드·렌터 애비뉴 (228건)**
- 잘란 타리 둘랑·잘란 타리 파용 (38건) 등 주의

**DENV-1 혈청형 증가**
- 대형 클러스터에서 DENV-1 혈청형 증가 추세
- 과거 뎅기 감염자도 DENV-1에 재감염될 수 있음

**한인 예방 체크리스트**
- 화분 받침대·에어컨 배수 고인 물 즉시 제거, 배수구 주 1회 청소
- 발코니 물통·양동이는 뒤집어 보관
- 고열·심한 두통·관절통·발진 시 GP 또는 폴리클리닉 방문, NS1 검사 요청
- 실시간 클러스터: **NEA myENV 앱** 확인

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "NEA · The Independent SG",
    sources: [
      { name: "The Independent SG — Dengue 119건·17 clusters", url: "https://theindependent.sg/dengue-cases-fall-to-119-last-week-but-singapore-still-has-17-active-clusters/" },
      { name: "NEA — DENV-1 증가 대응 촉구 (공식)", url: "https://www.nea.gov.sg/media/news/news/index/nea-urges-actions-to-block-dengue-amidst-increasing-denv-1-cases-in-large-dengue-clusters" },
    ],
    time: "2026년 8월 1일 주",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "교통",
    catStyle: "bg-[#EBF5F0] text-[#2B7A50]",
    title: "🚇 건국절 전날(오늘 8/8 밤) MRT 전 노선·버스 53개 연장운행 — 마리나베이 무료 셔틀 운행",
    summary: "LTA·SMRT·SBS Transit은 8월 8일(토) 건국기념일 전날 밤 MRT 6개 노선 전체·LRT 3개·버스 53개 노선 운행 시간을 연장한다. 막차는 도심 환승역 기준 1~2시간 연장되며, 마리나 베이 일대 무료 NDP 셔틀버스도 약 오전 1~1시 30분까지 운행된다. 일반 거리비례 요금 적용(야간 할증 없음). 8월 9일은 건국기념일, 10일(월)은 대체 공휴일.",
    fullContent: `**건국기념일 전날 (8월 8일 토요일) MRT·버스 연장운행**
NDP 관람 후 귀가에 참고하세요.

**연장 대상**
- **MRT 6개 노선 전체**(NSL·EWL·CCL·TEL·NEL·DTL) + **LRT 3개**(붕가왕·세랑군·풍골)
- 도심 환승역 기준 **막차 1~2시간 연장**
- **버스 53개 노선** 연장 (마리나 베이·에스플러네이드·오차드 주요 노선 포함)

**무료 셔틀버스**
- 마리나 베이 일대에 무료 NDP 셔틀버스 별도 운행
- 약 오전 1~1시 30분까지 (혼잡 상황에 따라 변동 가능)

**요금·참고**
- 연장 운행 구간 일반 거리비례 요금 적용 (무료 아님, 야간 할증 없음)
- **8월 9일(일): 건국기념일 / 8월 10일(월): 대체 공휴일**
- 캘랑 일대 도로통제로 차량 혼잡 예상 — 대중교통 이용 권장

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "LTA · SMRT · SBS Transit",
    sources: [
      { name: "SMRT — National Day Eve Extended Hours (공식)", url: "https://www.smrt.com.sg/news-publications/newsroom/service-announcements/last-bus-train-timings-extension-for-national-day-eve-2026/" },
      { name: "SBSTransit — Extended Operating Hours (공식)", url: "https://www.sbstransit.com.sg/news/extension-of-operational-hours-for-train-and-selected-bus-services-on-eve-of-national-day-5" },
    ],
    time: "2026년 8월 8일",
    isBreaking: true,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "사회",
    catStyle: "bg-[#F5F0FF] text-[#7040C0]",
    title: "📣 PM 웡 건국절 메시지 — 가족지원 '대규모 재검토' 예고, 육아비·보육 정책 8/23 랠리서 발표",
    summary: "로런스 웡 총리가 8월 8일 방송된 건국절(61주년) 메시지에서 가족 지원 방식의 '대규모 재검토(major review)'를 예고했다. 아이 양육 비용, 영아·유아 보육시설 접근성 등을 새롭게 검토하겠다는 방침이며, 구체적인 정책 패키지는 8월 23일(일) 국경일 랠리(National Day Rally)에서 발표된다. 글로벌 무역장벽 고조 속에서도 개방성을 유지하겠다는 메시지도 담겼다.",
    fullContent: `**로런스 웡 총리 건국절 메시지 (2026년 8월 8일 방송)**
로런스 웡 총리가 8월 8일 방송된 건국절(61주년) 메시지에서 주요 방향을 공개했습니다.

**가족 지원 대규모 재검토 예고**
- 많은 가정이 일·가정·부모 돌봄을 동시에 감당하며 '버티기 바쁜' 상황에 처해 있음을 지적
- 정부가 가족 지원 방식을 **'대규모 재검토(major review)'**할 계획
- 검토 항목: **아이 양육 비용**, **영아·유아 보육시설 접근성**, 가족 부담 경감 방안

**8월 23일 국경일 랠리에서 정책 발표**
- 세부 지원 패키지는 **8월 23일(일) 국경일 랠리(National Day Rally)**에서 공개 예정

**한인 참고**
- 영아·어린이집 이용 한인 가정도 영향을 받을 수 있는 정책이 나올 수 있으니 8월 23일 발표를 주목하세요.
- 외국인(EP·DP 비자)은 일부 시민 전용 혜택에서 제외될 수 있으니 발표 후 자격 조건 확인 필요

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "PMO · MustShareNews",
    sources: [
      { name: "PMO — National Day Message 2026 (공식)", url: "https://www.pmo.gov.sg/newsroom/national-day-message-2026/" },
      { name: "MustShareNews — PM Wong promises major review for families", url: "https://mustsharenews.com/national-day-message-2026/" },
    ],
    time: "2026년 8월 8일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "📋 비전통 출신국 직종 목록(NTS-OL) 9월 1일 8개 직종 추가 — 육아도우미·웨이터·기내승무원 등",
    summary: "인력부(MOM)가 9월 1일부터 비전통 출신국 워크퍼밋(NTS-OL) 허용 직종을 8개 추가한다. 신규 직종은 사회서비스(육아도우미·에듀케러·교육보조원), 요식업(정육사·수산물판매원·식음료 보조·주방보조원·웨이터), 항공운송(기내승무원) 분야다. NTS 쿼터 8% 서브-DRC·최저 월급여 S$2,000 요건은 유지. F&B·보육 업종 한인 고용주에게 관련된 변경이다.",
    fullContent: `**비전통 출신국 직종 목록(NTS-OL) 확대 (2026년 9월 1일 발효)**
인력부(MOM)가 9월 1일부터 비전통 출신국(NTS) 워크퍼밋 허용 직종 목록을 넓힙니다.

**추가되는 8개 직종 (9월 1일부터)**
- **사회서비스**: 육아도우미·영아 돌봄사 / 에듀케러(Educarers) / 교육보조원(Teacher Aides)
- **요식업**: 정육사·수산물 관련 식품 준비원 / 식음료 스탠드 보조 / 주방보조원 / 웨이터
- **항공운송**: 기내승무원(Cabin Attendants)

**기존 요건 유지**
- NTS 서브-DRC: 전체 인력의 **8% 이내**
- 최저 고정 월급여: **S$2,000**

**한인 고용주 참고**
- F&B 매장·보육 서비스를 운영하는 한인 자영업자는 9월 1일부터 NTS 국가 출신 직원 채용 가능 직종이 확대됨
- 세부 조건·신청 방법은 MOM 공식 사이트 확인 필수

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "MOM · Malay Mail",
    sources: [
      { name: "Malay Mail — NTS-OL 8개 직종 추가 (2026년 3월 4일 발표)", url: "https://www.malaymail.com/news/singapore/2026/03/04/singapore-to-expand-nontraditional-source-occupation-list-with-eight-new-roles-from-september-2026/211246" },
      { name: "Fragomen — NTS-OL 확대 안내", url: "https://www.fragomen.com/insights/singapore-non-traditional-sources-occupation-list-to-be-expanded.html" },
    ],
    time: "2026년 9월 1일(발효)",
    isBreaking: false,
    readTime: "2분",
