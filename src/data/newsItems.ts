...
const RAW_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    title: "🚔 7/16~29 이슈랜드와이드 단속 — 스캐머·머니뮬 255명 조사, 660건·S$560만 피해",
    summary: "싱가포르 경찰청(SPF)이 7월 16~29일 상무부(CAD)·7개 경찰구역 합동으로 스캐머·머니뮬 혐의자 255명(남 172·여 83, 16~77세)을 조사했다고 발표했다. 전자상거래·피싱·취업·정부기관사칭·투자·행운권 등 660건 이상(피해 약 S$560만)과 연관됐다. 머니뮬(계좌·명의 대여자)은 태형·은행서비스 제한 등 처벌 대상이 될 수 있다.",
    fullContent: `**경찰 전국 사기 단속 결과 (SPF, 7월 30일 발표)**
싱가포르 경찰청이 7월 16~29일 2주간 벌인 전국 단속 결과입니다.

- **조사 인원: 255명** (남 172·여 83, 16~77세)
- **연관 사건: 660건 이상 / 피해액 약 S$560만(S$5.6 million)**
- **사기 유형**: 전자상거래·피싱·취업·정부기관사칭·투자·행운권 사기 등
...
정확한 내용은 원문(아래 출처)을 확인하세요.`,
    ...
    sources: [
      { name: "SPF (공식)", url: "https://www.police.gov.sg/Media-Hub/News/2026/07/20260730_police_investigate_255_scammers_and_money_mules_in_islandwide_enforcement_operation" },
      { name: "The Star", url: "https://www.thestar.com.my/aseanplus/2026/07/30/singapore-police-probe-255-over-scam-cases-involving-losses-of-about-56-million" },
    ],
    time: "2026년 7월 30일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "💵 MAS 7월 통화정책 — SGD NEER 상향 소폭 확대(2분기 연속), 물가 2027년 상반기까지 상승 지속",
    summary: "MAS(통화청)가 7월 27일 통화정책을 발표했다. SGD NEER 절상 속도를 소폭 높이는 조치를 2분기 연속(4월에 이어) 시행하며 밴드 중심·폭은 유지했다. 6월 근원물가(Core CPI)는 1.6%(5월 1.4%), CPI 전체는 1.9%(5월 1.8%)로 올랐다. MAS는 2026년 연간 물가를 1.5~2.5%로 전망하며 2027년 상반기까지 높은 수준이 지속될 것으로 예상했다.",
    fullContent: `**MAS 7월 2026 통화정책 성명 (7월 27일 발표)**
싱가포르 통화청(MAS)이 7월 27일 분기 통화정책 성명을 발표했습니다.

**정책 결정**
- SGD 명목실효환율(S$NEER) 절상 속도를 **소폭 확대** — 4월에 이어 **2분기 연속 강화**
- 밴드 **중심(midpoint)·폭(width)** 변경 없음

**물가 현황**
- 6월 근원물가(Core CPI): **1.6%** (5월 1.4%)
- 6월 CPI 전체: **1.9%** (5월 1.8%)
- 2026년 연간 전망: Core·All-Items 모두 **1.5~2.5%**

**향후 전망**
- 물가는 **2027년 상반기까지** 높은 수준 지속 예상
- 중동 사태·글로벌 유가·무역 불확실성이 변수

**한인 참고**
- SGD 강세 지속은 한국 송금 시 유리하게 작용할 수 있음 — 환율 알림(Wise·Instarem) 활용
- 물가 상승이 지속되므로 생활비 관리에 유의

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "MAS (공식) · CNBC · Mothership",
    sources: [
      { name: "MAS (공식)", url: "https://www.mas.gov.sg/news/monetary-policy-statements/2026/mas-monetary-policy-statement-27jul26" },
      { name: "CNBC", url: "https://www.cnbc.com/2026/07/27/singapore-mas-july-monetary-policy-middle-east-oil-prices-inflation-.html" },
      { name: "Mothership", url: "https://mothership.sg/2026/07/mas-singapore-dollar-appreciate-july-2026/" },
    ],
    time: "2026년 7월 27일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    category: "사회",
    catStyle: "bg-[#F5F0FF] text-[#7040C0]",
    title: "🤝 SPF-FBI 온라인사기·자금세탁 공동대응 MOU 체결 — 암호화폐 합동작전서 US$270만 피해 예방",
    summary: "싱가포르 경찰청(SPF)과 미국 FBI가 7월 24일 온라인 사기·사이버 범죄·자금세탁 공동 대응을 위한 MOU를 체결했다. 서명식은 주싱가포르 미국 대사관에서 열렸으며, SPF 부청장 Zhang Weihan과 FBI 부국장보 Heith R. Janke가 서명했다. 앞선 합동 암호화폐 추적 작전에서 미국에서 54명 피해자 보호·US$270만 피해 예방, 싱가포르에서는 S$38만8천의 손실을 막았다.",
    fullContent: `**SPF-FBI 공동대응 MOU 체결 (2026년 7월 24일)**
싱가포르 경찰청(SPF)과 미국 연방수사국(FBI)이 7월 24일 양국 법집행 협력을 강화하는 MOU를 체결했습니다.

**체결 내용**
- 서명식: 7월 24일 **주싱가포르 미국 대사관**
- SPF 측: Zhang Weihan 부청장(Deputy Commissioner)
- FBI 측: Heith R. Janke 부국장보(Assistant Director)
- 협력 범위: **온라인 사기, 사이버 가능 사기(Cyber-enabled Fraud), 자금세탁**

**합동 작전 성과 (MOU 체결 이전)**
- 미국: 피해자 **54명** 보호, **US$270만** 피해 예방
- 싱가포르: **S$38만8천** 손실 예방

**한인 참고**
- SPF-FBI 협력 강화로 국경을 넘는 암호화폐 사기·자금세탁에 대한 국제 공조가 강해집니다.
- 암호화폐 관련 의심스러운 연락은 1799(안티사기 핫라인)에 신고하세요.

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "SPF (공식) · Yahoo News SG",
    sources: [
      { name: "SPF (공식)", url: "https://www.police.gov.sg/Media-Hub/News/2026/07/20260724_signing_of_memorandum_of_understanding" },
      { name: "Yahoo News SG", url: "https://sg.news.yahoo.com/singapore-police-fbi-sign-mou-105000266.html" },
    ],
    time: "2026년 7월 24일",
    isBreaking: false,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "🦟 뎅기 DENV-3 우세종 전환 경보 — 인구 면역도 낮아 급증 위험, 7월 기준 DENV-3가 51.9%",
    summary: "NEA가 7월 21일 공개한 분기별 바이러스형 감시 데이터에 따르면 DENV-3(뎅기바이러스 3형)가 7월 기준 51.9%로 DENV-2(48.1%)를 처음 추월해 우세종이 됐다. DENV-3는 인구 면역도가 낮아 확산 위험이 높다. 2026년 상반기 누적 확진은 1,180건(H1 2025 대비 54% 감소)이지만 2분기는 1분기 대비 87.8% 증가해 피크 시즌 돌입이 우려된다.",
    fullContent: `**뎅기 DENV-3 우세종 전환 경보 (NEA, 7월 21일)**
싱가포르 국가환경청(NEA)의 분기별 뎅기바이러스형 감시 데이터입니다.

**바이러스형 현황 (2026년 7월 기준)**
- DENV-2: **48.1%**
- DENV-3: **51.9%** — 처음으로 DENV-2를 추월해 **우세종으로 전환**
- 연초(1월) 비교: DENV-3 19.1% → 6월 59.9% → 7월 51.9%(DENV-2가 반등해 역전)

**왜 위험한가**
- 싱가포르 인구 대다수가 DENV-3에 면역을 갖고 있지 않아 **감염 확산 속도가 빨라질 수 있음**
- 이전 우세종 DENV-2는 2023년 대규모 유행 이후 면역이 형성된 상태

**발생 현황**
- 2026년 **상반기(H1) 누적 1,180건** (H1 2025 2,583건 대비 **54% 감소**)
- 단, 2분기(Q2)는 1분기(Q1) 대비 **87.8% 증가** — 피크 시즌 진입 신호

**한인 가정 예방 체크리스트**
- 화분 받침대·에어컨 응결수 받이 고인 물 즉시 제거
- 발코니 양동이·물통 뒤집어 보관, 배수구 주 1회 청소
- 고열·심한 두통·관절통 시 GP/폴리클리닉 방문, NS1 검사 요청
- 실시간 클러스터는 NEA myENV 앱에서 확인

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "Asia News Network · NEA",
    sources: [
      { name: "Asia News Network", url: "https://asianews.network/dengue-cases-in-singapore-low-but-increasing-numbers-may-rise-further-with-dengue-strain-change/" },
      { name: "NEA", url: "https://www.nea.gov.sg/dengue-zika/dengue/dengue-clusters-under-surveillance" },
    ],
    time: "2026년 7월 21일",
    isBreaking: true,
    readTime: "2분",
  ...
  },
  {
    ...
    title: "🏠 HDB 임대료 6월 +0.6% 반등·콘도도 회복 — 성숙단지·집행형 플랫 강세, 전년比 +1.4%",
    summary: "99-SRX가 발표한 2026년 6월 임대 데이터에 따르면 HDB 임대료가 전월 대비 +0.6% 반등했다(5월 -0.3% 하락 후 회복). 성숙단지 +0.7%, 비성숙단지 +0.4%, 집행형(Executive) +1.2%로 강세. 거래량도 전월 대비 +4.8% 증가해 약 2,725건. 전년 동월 대비로는 +1.4%다.",
    fullContent: `**2026년 6월 HDB 임대료 반등 (99-SRX, 7월 발표)**
99-SRX가 발표한 2026년 6월 임대 시장 데이터입니다.

**HDB 임대료**
- 전월比 **+0.6%** (5월 -0.3% 하락에서 반등)
- 성숙단지(Mature): **+0.7%** / 비성숙단지(Non-mature): **+0.4%**
- 평형별: 3룸 +0.7% / 4룸 -0.1% / 5룸 +0.6% / 집행형(Executive) **+1.2%**
- 거래량: 약 **2,725건** (전월比 +4.8%)
- 전년 동월 대비: **+1.4%**

**참고**
- 5월 하락 후 6월 반등한 흐름으로, 추세 전환인지 일시 반등인지는 추가 데이터 확인이 필요합니다.
- 단지·평형별 편차가 크니 실제 매물로 비교하세요.

정확한 내용은 원문(아래 출처)을 확인하세요.`,
    source: "99.co (SRX)",
    sources: [
      { name: "99.co (SRX)", url: "https://www.99.co/singapore/insider/condo-hdb-rental-market-rebound-june-2026/" },
    ],
    time: "2026년 7월",
    isBreaking: false,
    readTime: "2분",
