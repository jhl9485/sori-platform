export type FleaStatus = "판매중" | "예약중" | "판매완료";
...
// 연락처 필드를 따로 두지 않는 것이 방침이다(부동산과 동일) — 판매자가 원하는 연락 방법을
// description에 직접 적는다. 작성 화면(flea/write)도 "상품 설명과 연락 방법"으로 안내하고 있다.
// 그런데 예시 물건 3건에는 정작 연락 방법이 하나도 없어서, 보는 사람은 "그래서 어떻게 연락하지"가
// 됐고 글 쓰는 사람에게는 따라 쓸 본보기가 없었다 → 3건 모두 "**연락 방법**" 문단을 넣었다.
...
**연락 방법**
카톡 ID: bishan_daikin (왓츠앱도 같은 아이디로 찾으실 수 있어요)
편한 시간 남겨주시면 회신드릴게요.`,
    canDeliver: false,
    canMeet: true,
  },
...
**연락 방법**
카톡 ID: techkim_sg
Tanjong Pagar 사무실 근처에서 점심시간에 실물 확인 가능합니다.`,
    canDeliver: false,
    canMeet: true,
  },
  {
...
**연락 방법**
카톡 ID: buona_jeongi
낮에는 답이 늦을 수 있어요. 메시지 남겨주시면 저녁에 회신드립니다.`,
    canDeliver: false,
    canMeet: true,
  },
];
