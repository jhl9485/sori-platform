...
const RAW_COMMUNITY_POSTS: CommunityPost[] = [
  {
    ...
    title: "이번 달 전기세 보고 놀라서 에어컨 습관 좀 바꿔봤어요",
    preview: "전기요금 오른다더니 지난달 청구서 보고 놀랐네요. 온도 살짝 올리고 선풍기 같이 쓰는 걸로 바꿔봤어요.",
    fullContent: `7월 되고 전기요금 오른다는 얘기 듣긴 했는데, 막상 지난달 청구서 보니까 생각보다 확 나와서 좀 놀랐어요ㅠㅠ 저희 집이 에어컨을 거의 하루종일 틀어놓는 편이거든요.

그래서 이번 달부터 몇 가지 바꿔봤어요. 온도를 24도에서 25~26도로 살짝 올리고, 잘 때는 타이머 걸어두고요. 선풍기랑 같이 트니까 체감은 비슷하면서 에어컨 도는 시간이 줄더라구요. 필터도 오랜만에 청소했는데 이게 은근 효과 있다고 하더라구요.

아직 한 달치 결과는 안 나와서 얼마나 줄었는지는 모르겠지만, 신경 쓰기 시작하니까 마음은 좀 놓이네요. 다음 청구서 나오면 비교해보려구요.`,
    tags: ["전기세", "에어컨", "생활정보", "절약"],
    views: "47",
    comments: "0",
    likes: "9",
  },
  {
    ...
    title: "싱가포르 회사 첫 출근하고 문화 차이에 좀 얼떨떨했던 날",
    preview: "점심 각자 먹고 퇴근도 눈치 안 보고... 한국이랑 달라서 처음엔 뻘쭘했는데 며칠 지나니 오히려 편하네요.",
    fullContent: `얼마 전에 여기 회사로 첫 출근했는데, 한국이랑 분위기가 꽤 달라서 며칠 동안 좀 얼떨떨했어요.

일단 점심을 다들 따로 먹더라구요? 한국에선 팀이 우르르 같이 나갔는데, 여기선 각자 알아서 호커 가거나 자리에서 먹거나 하는 분위기라 처음엔 살짝 뻘쭘했어요. 근데 며칠 지나니까 오히려 편하더라구요. 퇴근도 눈치 안 보고 시간 되면 그냥 일어나는 게 아직 적응 중이에요. 좋은데 뭔가 어색한ㅎㅎ

영어 회의는 아직 긴장되지만 다들 천천히 말해주려고 해서 생각보단 괜찮았어요. 첫 주엔 걱정 많았는데, 지나고 보니 대부분 제가 미리 겁먹은 거더라구요. 이제 막 시작하시는 분들도 너무 걱정 안 하셔도 될 거 같아요.`,
    tags: ["취업", "첫출근", "회사생활", "적응"],
    views: "62",
    comments: "0",
    likes: "14",
  ...
  },
  {
    ...
    author: "익명",
    time: "어제",
    createdAt: "2026-07-05T20:00:00",
    title: "회의 때 영어 때문에 위축되는 거, 조금씩 나아지고 있어요",
    preview: "회의에서 영어로 말할 때마다 심장이 벌렁... 근데 미리 몇 문장 적어가기 시작하니 조금씩 자신감이 붙네요.",
    fullContent: `익명으로 조심스럽게 적어봐요. 여기서 일한 지 좀 됐는데도 아직 회의에서 영어로 말할 때마다 심장이 벌렁거리더라구요ㅠㅠ 머릿속으론 할 말이 있는데, 막상 입 밖으로 내려면 문장이 꼬이고, 타이밍 놓치고 그냥 넘어간 적도 많았어요.

한동안은 '나만 이렇게 부족한가' 싶어서 위축됐었는데, 얼마 전부터 회의 전에 할 말을 미리 몇 문장 적어가기 시작했어요. 완벽하진 않아도 준비한 말이라도 뱉으니까 조금씩 자신감이 붙더라구요. 동료가 '네 아이디어 좋았다'고 한마디 해준 날은 괜히 하루 종일 기분 좋았어요.

아직 갈 길은 멀지만 예전보단 확실히 덜 무서워졌어요. 저처럼 영어 때문에 주눅 들었던 분들도 너무 자책 안 하셨으면 좋겠어요. 다들 각자 속도로 적응하는 거니까요.`,
    tags: ["영어", "직장", "고민"],
    views: "88",
    comments: "0",
    likes: "23",
